 ...
 497                     ; 121     TIM2->CCMR1 = (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_OCM)) |
 497                     ; 122                             (uint8_t)TIM2_OCMode);
 499  0084 c65307        	ld	a,21255
 500  0087 a48f          	and	a,#143
 501  0089 1a02          	or	a,(OFST+1,sp)
 502  008b c75307        	ld	21255,a
 503                     ; 125     TIM2->CCR1H = (uint8_t)(TIM2_Pulse >> 8);
 505  008e 7b06          	ld	a,(OFST+5,sp)
 506  0090 c75311        	ld	21265,a
 507                     ; 126     TIM2->CCR1L = (uint8_t)(TIM2_Pulse);
 509  0093 7b07          	ld	a,(OFST+6,sp)
 510  0095 c75312        	ld	21266,a
 511                     ; 127 }
 514  0098 5b03          	addw	sp,#3
 515  009a 81            	ret
 579                     ; 138 void TIM2_OC2Init(TIM2_OCMode_TypeDef TIM2_OCMode,
 579                     ; 139                   TIM2_OutputState_TypeDef TIM2_OutputState,
 579                     ; 140                   uint16_t TIM2_Pulse,
 579                     ; 141                   TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
 579                     ; 142 {
 580                     	switch	.text
 ...
 588                     ; 144     assert_param(IS_TIM2_OC_MODE_OK(TIM2_OCMode));
 590                     ; 145     assert_param(IS_TIM2_OUTPUT_STATE_OK(TIM2_OutputState));
 592                     ; 146     assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
 594                     ; 150     TIM2->CCER1 &= (uint8_t)(~( TIM2_CCER1_CC2E |  TIM2_CCER1_CC2P ));
 596  009d c6530a        	ld	a,21258
 597  00a0 a4cf          	and	a,#207
 598  00a2 c7530a        	ld	21258,a
 599                     ; 152     TIM2->CCER1 |= (uint8_t)((uint8_t)(TIM2_OutputState  & TIM2_CCER1_CC2E ) |
 599                     ; 153                         (uint8_t)(TIM2_OCPolarity & TIM2_CCER1_CC2P));
 ...
 610                     ; 157     TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_OCM)) | 
 610                     ; 158                             (uint8_t)TIM2_OCMode);
 612  00b6 c65308        	ld	a,21256
 613  00b9 a48f          	and	a,#143
 614  00bb 1a02          	or	a,(OFST+1,sp)
 615  00bd c75308        	ld	21256,a
 616                     ; 162     TIM2->CCR2H = (uint8_t)(TIM2_Pulse >> 8);
 618  00c0 7b06          	ld	a,(OFST+5,sp)
 619  00c2 c75313        	ld	21267,a
 620                     ; 163     TIM2->CCR2L = (uint8_t)(TIM2_Pulse);
 622  00c5 7b07          	ld	a,(OFST+6,sp)
 623  00c7 c75314        	ld	21268,a
 624                     ; 164 }
 627  00ca 5b03          	addw	sp,#3
 628  00cc 81            	ret
 692                     ; 175 void TIM2_OC3Init(TIM2_OCMode_TypeDef TIM2_OCMode,
 692                     ; 176                   TIM2_OutputState_TypeDef TIM2_OutputState,
 692                     ; 177                   uint16_t TIM2_Pulse,
 692                     ; 178                   TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
 692                     ; 179 {
 693                     	switch	.text
 ...
 701                     ; 181     assert_param(IS_TIM2_OC_MODE_OK(TIM2_OCMode));
 703                     ; 182     assert_param(IS_TIM2_OUTPUT_STATE_OK(TIM2_OutputState));
 705                     ; 183     assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
 707                     ; 185     TIM2->CCER2 &= (uint8_t)(~( TIM2_CCER2_CC3E  | TIM2_CCER2_CC3P));
 709  00cf c6530b        	ld	a,21259
 710  00d2 a4fc          	and	a,#252
 711  00d4 c7530b        	ld	21259,a
 712                     ; 187     TIM2->CCER2 |= (uint8_t)((uint8_t)(TIM2_OutputState & TIM2_CCER2_CC3E) |  
 712                     ; 188                              (uint8_t)(TIM2_OCPolarity & TIM2_CCER2_CC3P));
...
1168  0161               L364:
1169                     ; 297         icselection = (uint8_t)TIM2_ICSELECTION_DIRECTTI;
...
3192                     ; 1011     tmpccr1 |= (uint16_t)((uint16_t)tmpccr1h << 8);
...
3412                     ; 1053     return (uint16_t)tmpccr3;
3414  03d4 1e03          	ldw	x,(OFST-1,sp)
3417  03d6 5b04          	addw	sp,#4
3418  03d8 81            	ret
3452                     ; 1061 uint16_t TIM2_GetCounter(void)
3452                     ; 1062 {
3453                     	switch	.text
3454  03d9               _TIM2_GetCounter:
3456  03d9 89            	pushw	x
3457       00000002      OFST:	set	2
3460                     ; 1063      uint16_t tmpcntr = 0;
3462                     ; 1065     tmpcntr =  ((uint16_t)TIM2->CNTRH << 8);
...
3471                     ; 1067     return (uint16_t)( tmpcntr| (uint16_t)(TIM2->CNTRL));
...
3484  03f1 81            	ret
3508                     ; 1076 TIM2_Prescaler_TypeDef TIM2_GetPrescaler(void)
3508                     ; 1077 {
3509                     	switch	.text
3510  03f2               _TIM2_GetPrescaler:
3514                     ; 1079     return (TIM2_Prescaler_TypeDef)(TIM2->PSCR);
3516  03f2 c6530e        	ld	a,21262
3519  03f5 81            	ret
3658                     ; 1096 FlagStatus TIM2_GetFlagStatus(TIM2_FLAG_TypeDef TIM2_FLAG)
3658                     ; 1097 {
3659                     	switch	.text
...
3667                     ; 1098     FlagStatus bitstatus = RESET;
3669                     ; 1099     uint8_t tim2_flag_l = 0, tim2_flag_h = 0;
3673                     ; 1102     assert_param(IS_TIM2_GET_FLAG_OK(TIM2_FLAG));
3675                     ; 1104     tim2_flag_l = (uint8_t)(TIM2->SR1 & (uint8_t)TIM2_FLAG);
3677  03f8 9f            	ld	a,xl
3678  03f9 c45304        	and	a,21252
3679  03fc 6b01          	ld	(OFST-1,sp),a
3681                     ; 1105     tim2_flag_h = (uint8_t)((uint16_t)TIM2_FLAG >> 8);
3683  03fe 7b03          	ld	a,(OFST+1,sp)
3684  0400 6b02          	ld	(OFST+0,sp),a
3686                     ; 1107     if ((tim2_flag_l | (uint8_t)(TIM2->SR2 & tim2_flag_h)) != (uint8_t)RESET )
3688  0402 c65305        	ld	a,21253
3689  0405 1402          	and	a,(OFST+0,sp)
3690  0407 1a01          	or	a,(OFST-1,sp)
3691  0409 2706          	jreq	L5371
3692                     ; 1109         bitstatus = SET;
3694  040b a601          	ld	a,#1
3695  040d 6b02          	ld	(OFST+0,sp),a
3698  040f 2002          	jra	L7371
3699  0411               L5371:
3700                     ; 1113         bitstatus = RESET;
3702  0411 0f02          	clr	(OFST+0,sp)
3704  0413               L7371:
3705                     ; 1115     return (FlagStatus)bitstatus;
3707  0413 7b02          	ld	a,(OFST+0,sp)
3710  0415 5b04          	addw	sp,#4
3711  0417 81            	ret
3746                     ; 1132 void TIM2_ClearFlag(TIM2_FLAG_TypeDef TIM2_FLAG)
3746                     ; 1133 {
3747                     	switch	.text
3748  0418               _TIM2_ClearFlag:
3752                     ; 1135     assert_param(IS_TIM2_CLEAR_FLAG_OK(TIM2_FLAG));
3754                     ; 1138     TIM2->SR1 = (uint8_t)(~((uint8_t)(TIM2_FLAG)));
3756  0418 9f            	ld	a,xl
3757  0419 43            	cpl	a
3758  041a c75304        	ld	21252,a
3759                     ; 1139     TIM2->SR2 = (uint8_t)(~((uint8_t)((uint8_t)TIM2_FLAG >> 8)));
3761  041d 35ff5305      	mov	21253,#255
3762                     ; 1140 }
3765  0421 81            	ret
3829                     ; 1154 ITStatus TIM2_GetITStatus(TIM2_IT_TypeDef TIM2_IT)
3829                     ; 1155 {
3830                     	switch	.text
...
3838                     ; 1156     ITStatus bitstatus = RESET;
3840                     ; 1157     uint8_t TIM2_itStatus = 0, TIM2_itEnable = 0;
3844                     ; 1160     assert_param(IS_TIM2_GET_IT_OK(TIM2_IT));
3846                     ; 1162     TIM2_itStatus = (uint8_t)(TIM2->SR1 & TIM2_IT);
3848  0424 c45304        	and	a,21252
3849  0427 6b01          	ld	(OFST-1,sp),a
3851                     ; 1164     TIM2_itEnable = (uint8_t)(TIM2->IER & TIM2_IT);
3853  0429 c65303        	ld	a,21251
3854  042c 1403          	and	a,(OFST+1,sp)
3855  042e 6b02          	ld	(OFST+0,sp),a
3857                     ; 1166     if ((TIM2_itStatus != (uint8_t)RESET ) && (TIM2_itEnable != (uint8_t)RESET ))
3859  0430 0d01          	tnz	(OFST-1,sp)
3860  0432 270a          	jreq	L1102
3862  0434 0d02          	tnz	(OFST+0,sp)
3863  0436 2706          	jreq	L1102
3864                     ; 1168         bitstatus = SET;
3866  0438 a601          	ld	a,#1
3867  043a 6b02          	ld	(OFST+0,sp),a
3870  043c 2002          	jra	L3102
3871  043e               L1102:
3872                     ; 1172         bitstatus = RESET;
3874  043e 0f02          	clr	(OFST+0,sp)
3876  0440               L3102:
3877                     ; 1174     return (ITStatus)(bitstatus);
3879  0440 7b02          	ld	a,(OFST+0,sp)
3882  0442 5b03          	addw	sp,#3
3883  0444 81            	ret
3919                     ; 1188 void TIM2_ClearITPendingBit(TIM2_IT_TypeDef TIM2_IT)
3919                     ; 1189 {
3920                     	switch	.text
3921  0445               _TIM2_ClearITPendingBit:
3925                     ; 1191     assert_param(IS_TIM2_IT_OK(TIM2_IT));
3927                     ; 1194     TIM2->SR1 = (uint8_t)(~TIM2_IT);
3929  0445 43            	cpl	a
3930  0446 c75304        	ld	21252,a
3931                     ; 1195 }
3934  0449 81            	ret
3986                     ; 1214 static void TI1_Config(uint8_t TIM2_ICPolarity,
3986                     ; 1215                        uint8_t TIM2_ICSelection,
3986                     ; 1216                        uint8_t TIM2_ICFilter)
3986                     ; 1217 {
3987                     	switch	.text
...
3995                     ; 1219     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1E);
3997  044c 7211530a      	bres	21258,#0
3998                     ; 1222     TIM2->CCMR1  = (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~(uint8_t)( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF )))
3998                     ; 1223                              | (uint8_t)(((TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
4012                     ; 1226     if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
4014  0465 0d02          	tnz	(OFST+1,sp)
4015  0467 2706          	jreq	L1602
4016                     ; 1228         TIM2->CCER1 |= TIM2_CCER1_CC1P;
4018  0469 7212530a      	bset	21258,#1
4020  046d 2004          	jra	L3602
4021  046f               L1602:
4022                     ; 1232         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1P);
4024  046f 7213530a      	bres	21258,#1
4025  0473               L3602:
4026                     ; 1235     TIM2->CCER1 |= TIM2_CCER1_CC1E;
4028  0473 7210530a      	bset	21258,#0
4029                     ; 1236 }
4032  0477 5b03          	addw	sp,#3
4033  0479 81            	ret
4085                     ; 1255 static void TI2_Config(uint8_t TIM2_ICPolarity,
4085                     ; 1256                        uint8_t TIM2_ICSelection,
4085                     ; 1257                        uint8_t TIM2_ICFilter)
4085                     ; 1258 {
4086                     	switch	.text
...
4094                     ; 1260     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2E);
4096  047c 7219530a      	bres	21258,#4
4097                     ; 1263     TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~(uint8_t)( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF ))) 
4097                     ; 1264                             | (uint8_t)(( (TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
4111                     ; 1268     if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
4113  0495 0d02          	tnz	(OFST+1,sp)
4114  0497 2706          	jreq	L3112
4115                     ; 1270         TIM2->CCER1 |= TIM2_CCER1_CC2P;
4117  0499 721a530a      	bset	21258,#5
4119  049d 2004          	jra	L5112
4120  049f               L3112:
4121                     ; 1274         TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2P);
4123  049f 721b530a      	bres	21258,#5
4124  04a3               L5112:
4125                     ; 1278     TIM2->CCER1 |= TIM2_CCER1_CC2E;
4127  04a3 7218530a      	bset	21258,#4
4128                     ; 1280 }
4131  04a7 5b03          	addw	sp,#3
4132  04a9 81            	ret
4184                     ; 1296 static void TI3_Config(uint8_t TIM2_ICPolarity, uint8_t TIM2_ICSelection,
4184                     ; 1297                        uint8_t TIM2_ICFilter)
4184                     ; 1298 {
4185                     	switch	.text
...
4193                     ; 1300     TIM2->CCER2 &=  (uint8_t)(~TIM2_CCER2_CC3E);
4195  04ac 7211530b      	bres	21259,#0
4196                     ; 1303     TIM2->CCMR3 = (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF))) 
4196                     ; 1304                             | (uint8_t)(( (TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
4210                     ; 1308     if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
4212  04c5 0d02          	tnz	(OFST+1,sp)
4213  04c7 2706          	jreq	L5412
4214                     ; 1310         TIM2->CCER2 |= TIM2_CCER2_CC3P;
4216  04c9 7212530b      	bset	21259,#1
4218  04cd 2004          	jra	L7412
4219  04cf               L5412:
4220                     ; 1314         TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3P);
4222  04cf 7213530b      	bres	21259,#1
4223  04d3               L7412:
4224                     ; 1317     TIM2->CCER2 |= TIM2_CCER2_CC3E;
