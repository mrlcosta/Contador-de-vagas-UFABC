 ...
 549                     ; 90     assert_param(IS_ADC1_CHANNEL_OK(ADC1_Channel));
 551                     ; 91     assert_param(IS_ADC1_PRESSEL_OK(ADC1_PrescalerSelection));
 553                     ; 92     assert_param(IS_ADC1_EXTTRIG_OK(ADC1_ExtTrigger));
 555                     ; 93     assert_param(IS_FUNCTIONALSTATE_OK(((ADC1_ExtTriggerState))));
 557                     ; 94     assert_param(IS_ADC1_ALIGN_OK(ADC1_Align));
 559                     ; 95     assert_param(IS_ADC1_SCHMITTTRIG_OK(ADC1_SchmittTriggerChannel));
 561                     ; 96     assert_param(IS_FUNCTIONALSTATE_OK(ADC1_SchmittTriggerState));
 563                     ; 101     ADC1_ConversionConfig(ADC1_ConversionMode, ADC1_Channel, ADC1_Align);
 ...
 638                     	switch	.text
 639  0059               _ADC1_Cmd:
 643                     ; 130     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 645                     ; 132     if (NewState != DISABLE)
 647  0059 4d            	tnz	a
 648  005a 2706          	jreq	L362
 649                     ; 134         ADC1->CR1 |= ADC1_CR1_ADON;
 651  005c 72105401      	bset	21505,#0
 653  0060 2004          	jra	L562
 654  0062               L362:
 655                     ; 138         ADC1->CR1 &= (uint8_t)(~ADC1_CR1_ADON);
 657  0062 72115401      	bres	21505,#0
 658  0066               L562:
 659                     ; 141 }
 662  0066 81            	ret
 697                     ; 148 void ADC1_ScanModeCmd(FunctionalState NewState)
 697                     ; 149 {
 698                     	switch	.text
 699  0067               _ADC1_ScanModeCmd:
 703                     ; 152     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 705                     ; 154     if (NewState != DISABLE)
 707  0067 4d            	tnz	a
 708  0068 2706          	jreq	L503
 709                     ; 156         ADC1->CR2 |= ADC1_CR2_SCAN;
 711  006a 72125402      	bset	21506,#1
 713  006e 2004          	jra	L703
 714  0070               L503:
 715                     ; 160         ADC1->CR2 &= (uint8_t)(~ADC1_CR2_SCAN);
 717  0070 72135402      	bres	21506,#1
 718  0074               L703:
 719                     ; 163 }
 722  0074 81            	ret
 757                     ; 170 void ADC1_DataBufferCmd(FunctionalState NewState)
 757                     ; 171 {
 758                     	switch	.text
 759  0075               _ADC1_DataBufferCmd:
 763                     ; 174     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 765                     ; 176     if (NewState != DISABLE)
 767  0075 4d            	tnz	a
 768  0076 2706          	jreq	L723
 769                     ; 178         ADC1->CR3 |= ADC1_CR3_DBUF;
 771  0078 721e5403      	bset	21507,#7
 773  007c 2004          	jra	L133
 774  007e               L723:
 775                     ; 182         ADC1->CR3 &= (uint8_t)(~ADC1_CR3_DBUF);
 777  007e 721f5403      	bres	21507,#7
 778  0082               L133:
 779                     ; 185 }
 782  0082 81            	ret
 938                     ; 196 void ADC1_ITConfig(ADC1_IT_TypeDef ADC1_IT, FunctionalState NewState)
 938                     ; 197 {
 939                     	switch	.text
 940  0083               _ADC1_ITConfig:
 942  0083 89            	pushw	x
 943       00000000      OFST:	set	0
 946                     ; 200     assert_param(IS_ADC1_IT_OK(ADC1_IT));
 948                     ; 201     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 950                     ; 203     if (NewState != DISABLE)
 952  0084 0d05          	tnz	(OFST+5,sp)
 953  0086 2709          	jreq	L714
 954                     ; 206         ADC1->CSR |= (uint8_t)ADC1_IT;
 956  0088 9f            	ld	a,xl
 957  0089 ca5400        	or	a,21504
 958  008c c75400        	ld	21504,a
 960  008f 2009          	jra	L124
 961  0091               L714:
 962                     ; 211         ADC1->CSR &= (uint8_t)((uint16_t)~(uint16_t)ADC1_IT);
 ...
 972  009a 85            	popw	x
 973  009b 81            	ret
1009                     ; 222 void ADC1_PrescalerConfig(ADC1_PresSel_TypeDef ADC1_Prescaler)
1009                     ; 223 {
1010                     	switch	.text
1011  009c               _ADC1_PrescalerConfig:
1013  009c 88            	push	a
1014       00000000      OFST:	set	0
1017                     ; 226     assert_param(IS_ADC1_PRESSEL_OK(ADC1_Prescaler));
1019                     ; 229     ADC1->CR1 &= (uint8_t)(~ADC1_CR1_SPSEL);
1021  009d c65401        	ld	a,21505
1022  00a0 a48f          	and	a,#143
1023  00a2 c75401        	ld	21505,a
1024                     ; 231     ADC1->CR1 |= (uint8_t)(ADC1_Prescaler);
...
1032  00ad 84            	pop	a
1033  00ae 81            	ret
1080                     ; 244 void ADC1_SchmittTriggerConfig(ADC1_SchmittTrigg_TypeDef ADC1_SchmittTriggerChannel, FunctionalState NewState)
1080                     ; 245 {
1081                     	switch	.text
1082  00af               _ADC1_SchmittTriggerConfig:
1084  00af 89            	pushw	x
1085       00000000      OFST:	set	0
1088                     ; 248     assert_param(IS_ADC1_SCHMITTTRIG_OK(ADC1_SchmittTriggerChannel));
1090                     ; 249     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1092                     ; 251     if (ADC1_SchmittTriggerChannel == ADC1_SCHMITTTRIG_ALL)
1094  00b0 9e            	ld	a,xh
1095  00b1 a1ff          	cp	a,#255
1096  00b3 2620          	jrne	L364
1097                     ; 253         if (NewState != DISABLE)
1099  00b5 9f            	ld	a,xl
1100  00b6 4d            	tnz	a
1101  00b7 270a          	jreq	L564
1102                     ; 255             ADC1->TDRL &= (uint8_t)0x0;
1104  00b9 725f5407      	clr	21511
1105                     ; 256             ADC1->TDRH &= (uint8_t)0x0;
1107  00bd 725f5406      	clr	21510
1109  00c1 2078          	jra	L174
1110  00c3               L564:
1111                     ; 260             ADC1->TDRL |= (uint8_t)0xFF;
1113  00c3 c65407        	ld	a,21511
1114  00c6 aaff          	or	a,#255
1115  00c8 c75407        	ld	21511,a
1116                     ; 261             ADC1->TDRH |= (uint8_t)0xFF;
...
1167  010a               L374:
1168                     ; 277         if (NewState != DISABLE)
1170  010a 0d02          	tnz	(OFST+2,sp)
1171  010c 2718          	jreq	L305
1172                     ; 279             ADC1->TDRH &= (uint8_t)(~(uint8_t)((uint8_t)0x01 << ((uint8_t)ADC1_SchmittTriggerChannel - (uint8_t)8)));
...
1191  0126               L305:
1192                     ; 283             ADC1->TDRH |= (uint8_t)((uint8_t)0x01 << ((uint8_t)ADC1_SchmittTriggerChannel - (uint8_t)8));
...
1212  013b 85            	popw	x
1213  013c 81            	ret
1270                     ; 300 void ADC1_ConversionConfig(ADC1_ConvMode_TypeDef ADC1_ConversionMode, ADC1_Channel_TypeDef ADC1_Channel, ADC1_Align_TypeDef ADC1_Align)
1270                     ; 301 {
1271                     	switch	.text
1272  013d               _ADC1_ConversionConfig:
1274  013d 89            	pushw	x
1275       00000000      OFST:	set	0
1278                     ; 304     assert_param(IS_ADC1_CONVERSIONMODE_OK(ADC1_ConversionMode));
1280                     ; 305     assert_param(IS_ADC1_CHANNEL_OK(ADC1_Channel));
1282                     ; 306     assert_param(IS_ADC1_ALIGN_OK(ADC1_Align));
1284                     ; 309     ADC1->CR2 &= (uint8_t)(~ADC1_CR2_ALIGN);
1286  013e 72175402      	bres	21506,#3
1287                     ; 311     ADC1->CR2 |= (uint8_t)(ADC1_Align);
1289  0142 c65402        	ld	a,21506
1290  0145 1a05          	or	a,(OFST+5,sp)
1291  0147 c75402        	ld	21506,a
1292                     ; 313     if (ADC1_ConversionMode == ADC1_CONVERSIONMODE_CONTINUOUS)
1294  014a 9e            	ld	a,xh
1295  014b a101          	cp	a,#1
1296  014d 2606          	jrne	L535
1297                     ; 316         ADC1->CR1 |= ADC1_CR1_CONT;
1299  014f 72125401      	bset	21505,#1
1301  0153 2004          	jra	L735
1302  0155               L535:
1303                     ; 321         ADC1->CR1 &= (uint8_t)(~ADC1_CR1_CONT);
1305  0155 72135401      	bres	21505,#1
1306  0159               L735:
1307                     ; 325     ADC1->CSR &= (uint8_t)(~ADC1_CSR_CH);
1309  0159 c65400        	ld	a,21504
1310  015c a4f0          	and	a,#240
1311  015e c75400        	ld	21504,a
1312                     ; 327     ADC1->CSR |= (uint8_t)(ADC1_Channel);
...
1320  0169 85            	popw	x
1321  016a 81            	ret
1367                     ; 342 void ADC1_ExternalTriggerConfig(ADC1_ExtTrig_TypeDef ADC1_ExtTrigger, FunctionalState NewState)
1367                     ; 343 {
1368                     	switch	.text
1369  016b               _ADC1_ExternalTriggerConfig:
1371  016b 89            	pushw	x
1372       00000000      OFST:	set	0
1375                     ; 346     assert_param(IS_ADC1_EXTTRIG_OK(ADC1_ExtTrigger));
1377                     ; 347     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1379                     ; 350     ADC1->CR2 &= (uint8_t)(~ADC1_CR2_EXTSEL);
1381  016c c65402        	ld	a,21506
1382  016f a4cf          	and	a,#207
1383  0171 c75402        	ld	21506,a
1384                     ; 352     if (NewState != DISABLE)
1386  0174 9f            	ld	a,xl
1387  0175 4d            	tnz	a
1388  0176 2706          	jreq	L365
1389                     ; 355         ADC1->CR2 |= (uint8_t)(ADC1_CR2_EXTTRIG);
1391  0178 721c5402      	bset	21506,#6
1393  017c 2004          	jra	L565
1394  017e               L365:
1395                     ; 360         ADC1->CR2 &= (uint8_t)(~ADC1_CR2_EXTTRIG);
1397  017e 721d5402      	bres	21506,#6
1398  0182               L565:
1399                     ; 364     ADC1->CR2 |= (uint8_t)(ADC1_ExtTrigger);
...
1407  018a 85            	popw	x
1408  018b 81            	ret
1432                     ; 378 void ADC1_StartConversion(void)
1432                     ; 379 {
1433                     	switch	.text
1434  018c               _ADC1_StartConversion:
1438                     ; 380     ADC1->CR1 |= ADC1_CR1_ADON;
1440  018c 72105401      	bset	21505,#0
1441                     ; 381 }
1444  0190 81            	ret
1488                     ; 390 uint16_t ADC1_GetConversionValue(void)
1488                     ; 391 {
1489                     	switch	.text
1490  0191               _ADC1_GetConversionValue:
1492  0191 5205          	subw	sp,#5
1493       00000005      OFST:	set	5
1496                     ; 393     uint16_t temph = 0;
1498                     ; 394     uint8_t templ = 0;
1500                     ; 396     if ((ADC1->CR2 & ADC1_CR2_ALIGN) != 0) /* Right alignment */
1502  0193 c65402        	ld	a,21506
1503  0196 a508          	bcp	a,#8
1504  0198 2715          	jreq	L126
1505                     ; 399         templ = ADC1->DRL;
...
1517                     ; 403         temph = (uint16_t)(templ | (uint16_t)(temph << (uint8_t)8));
...
1534                     ; 410         templ = ADC1->DRL;
1536  01b6 c65405        	ld	a,21509
1537  01b9 6b03          	ld	(OFST-2,sp),a
1539                     ; 412         temph = (uint16_t)((uint16_t)((uint16_t)templ << 6) | (uint16_t)((uint16_t)temph << 8));
...
1557  01d0               L326:
1558                     ; 415     return ((uint16_t)temph);
1560  01d0 1e04          	ldw	x,(OFST-1,sp)
1563  01d2 5b05          	addw	sp,#5
1564  01d4 81            	ret
1610                     ; 427 void ADC1_AWDChannelConfig(ADC1_Channel_TypeDef Channel, FunctionalState NewState)
1610                     ; 428 {
1611                     	switch	.text
1612  01d5               _ADC1_AWDChannelConfig:
1614  01d5 89            	pushw	x
1615       00000000      OFST:	set	0
1618                     ; 430     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1620                     ; 431     assert_param(IS_ADC1_CHANNEL_OK(Channel));
1622                     ; 433     if (Channel < (uint8_t)8)
1624  01d6 9e            	ld	a,xh
1625  01d7 a108          	cp	a,#8
1626  01d9 242e          	jruge	L746
1627                     ; 435         if (NewState != DISABLE)
1629  01db 9f            	ld	a,xl
1630  01dc 4d            	tnz	a
1631  01dd 2714          	jreq	L156
1632                     ; 437             ADC1->AWCRL |= (uint8_t)((uint8_t)1 << Channel);
...
1649  01f3               L156:
1650                     ; 441             ADC1->AWCRL &= (uint8_t)~(uint8_t)((uint8_t)1 << Channel);
...
1667  0209               L746:
1668                     ; 446         if (NewState != DISABLE)
1670  0209 0d02          	tnz	(OFST+2,sp)
1671  020b 2717          	jreq	L756
1672                     ; 448             ADC1->AWCRH |= (uint8_t)((uint8_t)1 << (Channel - (uint8_t)8));
...
1690  0224               L756:
1691                     ; 452             ADC1->AWCRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (uint8_t)(Channel - (uint8_t)8));
...
1712  023a 85            	popw	x
1713  023b 81            	ret
1748                     ; 463 void ADC1_SetHighThreshold(uint16_t Threshold)
1748                     ; 464 {
1749                     	switch	.text
1750  023c               _ADC1_SetHighThreshold:
1752  023c 89            	pushw	x
1753       00000000      OFST:	set	0
1756                     ; 465     ADC1->HTRH = (uint8_t)(Threshold >> (uint8_t)2);
1758  023d 54            	srlw	x
1759  023e 54            	srlw	x
1760  023f 9f            	ld	a,xl
1761  0240 c75408        	ld	21512,a
1762                     ; 466     ADC1->HTRL = (uint8_t)Threshold;
1764  0243 7b02          	ld	a,(OFST+2,sp)
1765  0245 c75409        	ld	21513,a
1766                     ; 467 }
1769  0248 85            	popw	x
1770  0249 81            	ret
1805                     ; 475 void ADC1_SetLowThreshold(uint16_t Threshold)
1805                     ; 476 {
1806                     	switch	.text
1807  024a               _ADC1_SetLowThreshold:
1811                     ; 477     ADC1->LTRL = (uint8_t)Threshold;
1813  024a 9f            	ld	a,xl
1814  024b c7540b        	ld	21515,a
1815                     ; 478     ADC1->LTRH = (uint8_t)(Threshold >> (uint8_t)2);
1817  024e 54            	srlw	x
1818  024f 54            	srlw	x
...
1821                     ; 479 }
1824  0254 81            	ret
1877                     ; 488 uint16_t ADC1_GetBufferValue(uint8_t Buffer)
1877                     ; 489 {
1878                     	switch	.text
...
1886                     ; 491     uint16_t temph = 0;
1888                     ; 492     uint8_t templ = 0;
1890                     ; 495     assert_param(IS_ADC1_BUFFER_OK(Buffer));
1892                     ; 497     if ((ADC1->CR2 & ADC1_CR2_ALIGN) != 0) /* Right alignment */
1894  0258 c65402        	ld	a,21506
1895  025b a508          	bcp	a,#8
1896  025d 271f          	jreq	L547
1897                     ; 500         templ = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1) + 1);
...
1906                     ; 502         temph = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1));
...
1917                     ; 504         temph = (uint16_t)(templ | (uint16_t)(temph << (uint8_t)8));
...
1926  027e               L547:
1927                     ; 509         temph = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1));
...
1938                     ; 511         templ = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1) + 1);
...
1947                     ; 513         temph = (uint16_t)((uint16_t)((uint16_t)templ << 6) | (uint16_t)(temph << 8));
...
1965  02a9               L747:
1966                     ; 516     return ((uint16_t)temph);
1968  02a9 1e04          	ldw	x,(OFST-1,sp)
1971  02ab 5b06          	addw	sp,#6
1972  02ad 81            	ret
2038                     ; 526 FlagStatus ADC1_GetAWDChannelStatus(ADC1_Channel_TypeDef Channel)
2038                     ; 527 {
2039                     	switch	.text
...
2047                     ; 528     uint8_t status = 0;
2049                     ; 531     assert_param(IS_ADC1_CHANNEL_OK(Channel));
2051                     ; 533     if (Channel < (uint8_t)8)
2053  02b0 a108          	cp	a,#8
2054  02b2 2412          	jruge	L3001
2055                     ; 535         status = (uint8_t)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << Channel));
2057  02b4 5f            	clrw	x
...
2072  02c6               L3001:
2073                     ; 539         status = (uint8_t)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (Channel - (uint8_t)8)));
...
2090  02da               L5001:
2091                     ; 542     return ((FlagStatus)status);
2093  02da 7b01          	ld	a,(OFST+0,sp)
2096  02dc 85            	popw	x
2097  02dd 81            	ret
2255                     ; 551 FlagStatus ADC1_GetFlagStatus(ADC1_Flag_TypeDef Flag)
2255                     ; 552 {
2256                     	switch	.text
...
2301                     ; 570             flagstatus = (uint8_t)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << temp));
...
2319  0317               L3011:
2320                     ; 574             flagstatus = (uint8_t)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (temp - 8)));
...
2338  032d               L1011:
2339                     ; 579         flagstatus = (uint8_t)(ADC1->CSR & Flag);
2341  032d c65400        	ld	a,21504
2342  0330 1402          	and	a,(OFST+1,sp)
2343  0332 6b01          	ld	(OFST+0,sp),a
2345  0334               L7701:
2346                     ; 581     return ((FlagStatus)flagstatus);
2348  0334 7b01          	ld	a,(OFST+0,sp)
2351  0336 85            	popw	x
2352  0337 81            	ret
2396                     ; 591 void ADC1_ClearFlag(ADC1_Flag_TypeDef Flag)
2396                     ; 592 {
2397                     	switch	.text
...
2437                     ; 609             ADC1->AWSRL &= (uint8_t)~(uint8_t)((uint8_t)1 << temp);
...
2455  0370               L1411:
2456                     ; 613             ADC1->AWSRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (temp - 8));
...
2474  0388               L7311:
2475                     ; 618         ADC1->CSR &= (uint8_t) (~Flag);
...
2485  0391 85            	popw	x
2486  0392 81            	ret
2541                     ; 640 ITStatus ADC1_GetITStatus(ADC1_IT_TypeDef ITPendingBit)
2541                     ; 641 {
2542                     	switch	.text
...
2550                     ; 642     ITStatus itstatus = RESET;
2552                     ; 643     uint8_t temp = 0;
2554                     ; 646     assert_param(IS_ADC1_ITPENDINGBIT_OK(ITPendingBit));
2556                     ; 648     if (((uint16_t)ITPendingBit & 0xF0) == 0x10)
...
2564                     ; 651         temp = (uint8_t)((uint16_t)ITPendingBit & 0x0F);
...
2575                     ; 654             itstatus = (ITStatus)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << temp));
...
2593  03bf               L7711:
2594                     ; 658             itstatus = (ITStatus)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (temp - 8)));
...
2612  03d5               L5711:
2613                     ; 663         itstatus = (ITStatus)(ADC1->CSR & (uint8_t)ITPendingBit);
2615  03d5 c65400        	ld	a,21504
2616  03d8 1403          	and	a,(OFST+2,sp)
2617  03da 6b01          	ld	(OFST+0,sp),a
2619  03dc               L3021:
2620                     ; 665     return ((ITStatus)itstatus);
2622  03dc 7b01          	ld	a,(OFST+0,sp)
2625  03de 5b03          	addw	sp,#3
2626  03e0 81            	ret
2671                     ; 687 void ADC1_ClearITPendingBit(ADC1_IT_TypeDef ITPendingBit)
2671                     ; 688 {
2672                     	switch	.text
...
2680                     ; 689     uint8_t temp = 0;
2682                     ; 692     assert_param(IS_ADC1_ITPENDINGBIT_OK(ITPendingBit));
2684                     ; 694     if (((uint16_t)ITPendingBit & 0xF0) == 0x10)
...
2692                     ; 697         temp = (uint8_t)((uint16_t)ITPendingBit & 0x0F);
...
2703                     ; 700             ADC1->AWSRL &= (uint8_t)~(uint8_t)((uint8_t)1 << temp);
...
2721  040f               L1321:
2722                     ; 704             ADC1->AWSRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (temp - 8));
...
2740  0427               L7221:
2741                     ; 709         ADC1->CSR &= (uint8_t)((uint16_t)~(uint16_t)ITPendingBit);
