 ...
 836                     ; 244     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM)) | 
 836                     ; 245                              (uint8_t)TIM1_OCMode);
 838  0146 c65259        	ld	a,21081
 839  0149 a48f          	and	a,#143
 840  014b 1a04          	or	a,(OFST+1,sp)
 841  014d c75259        	ld	21081,a
 842                     ; 248     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS2 | TIM1_OISR_OIS2N));
 844  0150 c6526f        	ld	a,21103
 845  0153 a4f3          	and	a,#243
 846  0155 c7526f        	ld	21103,a
 847                     ; 250     TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OISR_OIS2 & TIM1_OCIdleState) | 
 847                     ; 251                             (uint8_t)(TIM1_OISR_OIS2N & TIM1_OCNIdleState));
...
1023                     ; 308     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) | 
1023                     ; 309                              (uint8_t)TIM1_OCMode);
1025  01a3 c6525a        	ld	a,21082
1026  01a6 a48f          	and	a,#143
1027  01a8 1a04          	or	a,(OFST+1,sp)
1028  01aa c7525a        	ld	21082,a
1029                     ; 312     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS3 | TIM1_OISR_OIS3N));
1031  01ad c6526f        	ld	a,21103
1032  01b0 a4cf          	and	a,#207
1033  01b2 c7526f        	ld	21103,a
1034                     ; 314     TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OISR_OIS3 & TIM1_OCIdleState) | 
1034                     ; 315                             (uint8_t)(TIM1_OISR_OIS3N & TIM1_OCNIdleState));
...
1045                     ; 318     TIM1->CCR3H = (uint8_t)(TIM1_Pulse >> 8);
1047  01c7 7b09          	ld	a,(OFST+6,sp)
1048  01c9 c75269        	ld	21097,a
1049                     ; 319     TIM1->CCR3L = (uint8_t)(TIM1_Pulse);
1051  01cc 7b0a          	ld	a,(OFST+7,sp)
1052  01ce c7526a        	ld	21098,a
1053                     ; 321 }
1056  01d1 5b05          	addw	sp,#5
1057  01d3 81            	ret
1131                     ; 336 void TIM1_OC4Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1131                     ; 337                   TIM1_OutputState_TypeDef TIM1_OutputState,
1131                     ; 338                   uint16_t TIM1_Pulse,
1131                     ; 339                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1131                     ; 340                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState)
1131                     ; 341 {
1132                     	switch	.text
...
1140                     ; 343     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
1142                     ; 344     assert_param(IS_TIM1_OUTPUT_STATE_OK(TIM1_OutputState));
1144                     ; 345     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
1146                     ; 346     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
1148                     ; 349     TIM1->CCER2 &= (uint8_t)(~(TIM1_CCER2_CC4E | TIM1_CCER2_CC4P));
1150  01d6 c6525d        	ld	a,21085
1151  01d9 a4cf          	and	a,#207
1152  01db c7525d        	ld	21085,a
1153                     ; 351     TIM1->CCER2 |= (uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER2_CC4E ) |  
1153                     ; 352                              (uint8_t)(TIM1_OCPolarity  & TIM1_CCER2_CC4P ));
...
1164                     ; 355     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) | 
1164                     ; 356                             TIM1_OCMode);
1166  01ef c6525b        	ld	a,21083
1167  01f2 a48f          	and	a,#143
1168  01f4 1a02          	or	a,(OFST+1,sp)
1169  01f6 c7525b        	ld	21083,a
1170                     ; 359     if (TIM1_OCIdleState != TIM1_OCIDLESTATE_RESET)
1172  01f9 0d09          	tnz	(OFST+8,sp)
1173  01fb 270a          	jreq	L534
1174                     ; 361         TIM1->OISR |= (uint8_t)(~TIM1_CCER2_CC4P);
1176  01fd c6526f        	ld	a,21103
1177  0200 aadf          	or	a,#223
1178  0202 c7526f        	ld	21103,a
1180  0205 2004          	jra	L734
1181  0207               L534:
1182                     ; 365         TIM1->OISR &= (uint8_t)(~TIM1_OISR_OIS4);
1184  0207 721d526f      	bres	21103,#6
1185  020b               L734:
1186                     ; 369     TIM1->CCR4H = (uint8_t)(TIM1_Pulse >> 8);
1188  020b 7b06          	ld	a,(OFST+5,sp)
1189  020d c7526b        	ld	21099,a
1190                     ; 370     TIM1->CCR4L = (uint8_t)(TIM1_Pulse);
1192  0210 7b07          	ld	a,(OFST+6,sp)
1193  0212 c7526c        	ld	21100,a
1194                     ; 372 }
1197  0215 5b03          	addw	sp,#3
1198  0217 81            	ret
1403                     ; 387 void TIM1_BDTRConfig(TIM1_OSSIState_TypeDef TIM1_OSSIState,
1403                     ; 388                      TIM1_LockLevel_TypeDef TIM1_LockLevel,
1403                     ; 389                      uint8_t TIM1_DeadTime,
1403                     ; 390                      TIM1_BreakState_TypeDef TIM1_Break,
1403                     ; 391                      TIM1_BreakPolarity_TypeDef TIM1_BreakPolarity,
1403                     ; 392                      TIM1_AutomaticOutput_TypeDef TIM1_AutomaticOutput)
1403                     ; 393 {
1404                     	switch	.text
...
1412                     ; 395     assert_param(IS_TIM1_OSSI_STATE_OK(TIM1_OSSIState));
1414                     ; 396     assert_param(IS_TIM1_LOCK_LEVEL_OK(TIM1_LockLevel));
1416                     ; 397     assert_param(IS_TIM1_BREAK_STATE_OK(TIM1_Break));
1418                     ; 398     assert_param(IS_TIM1_BREAK_POLARITY_OK(TIM1_BreakPolarity));
1420                     ; 399     assert_param(IS_TIM1_AUTOMATIC_OUTPUT_STATE_OK(TIM1_AutomaticOutput));
1422                     ; 401     TIM1->DTR = (uint8_t)(TIM1_DeadTime);
1424  021a 7b06          	ld	a,(OFST+5,sp)
1425  021c c7526e        	ld	21102,a
1426                     ; 405     TIM1->BKR  =  (uint8_t)((uint8_t)(TIM1_OSSIState | (uint8_t)TIM1_LockLevel)  | 
1426                     ; 406                             (uint8_t)((uint8_t)(TIM1_Break | (uint8_t)TIM1_BreakPolarity)  | 
1426                     ; 407                             (uint8_t)TIM1_AutomaticOutput));
...
1651                     ; 431     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
1653                     ; 432     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
1655                     ; 433     assert_param(IS_TIM1_IC_SELECTION_OK(TIM1_ICSelection));
1657                     ; 434     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_ICPrescaler));
1659                     ; 435     assert_param(IS_TIM1_IC_FILTER_OK(TIM1_ICFilter));
1661                     ; 437     if (TIM1_Channel == TIM1_CHANNEL_1)
1663  0233 9e            	ld	a,xh
1664  0234 4d            	tnz	a
1665  0235 2614          	jrne	L766
1666                     ; 440         TI1_Config((uint8_t)TIM1_ICPolarity,
1666                     ; 441                    (uint8_t)TIM1_ICSelection,
1666                     ; 442                    (uint8_t)TIM1_ICFilter);
...
1676  0243 84            	pop	a
1677                     ; 444         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
1679  0244 7b06          	ld	a,(OFST+6,sp)
1680  0246 cd06b6        	call	_TIM1_SetIC1Prescaler
1683  0249 2046          	jra	L176
1684  024b               L766:
1685                     ; 446     else if (TIM1_Channel == TIM1_CHANNEL_2)
1687  024b 7b01          	ld	a,(OFST+1,sp)
1688  024d a101          	cp	a,#1
1689  024f 2614          	jrne	L376
1690                     ; 449         TI2_Config((uint8_t)TIM1_ICPolarity,
1690                     ; 450                    (uint8_t)TIM1_ICSelection,
1690                     ; 451                    (uint8_t)TIM1_ICFilter);
...
1700  025d 84            	pop	a
1701                     ; 453         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
1703  025e 7b06          	ld	a,(OFST+6,sp)
1704  0260 cd06c3        	call	_TIM1_SetIC2Prescaler
1707  0263 202c          	jra	L176
1708  0265               L376:
1709                     ; 455     else if (TIM1_Channel == TIM1_CHANNEL_3)
1711  0265 7b01          	ld	a,(OFST+1,sp)
1712  0267 a102          	cp	a,#2
1713  0269 2614          	jrne	L776
1714                     ; 458         TI3_Config((uint8_t)TIM1_ICPolarity,
1714                     ; 459                    (uint8_t)TIM1_ICSelection,
1714                     ; 460                    (uint8_t)TIM1_ICFilter);
...
1724  0277 84            	pop	a
1725                     ; 462         TIM1_SetIC3Prescaler(TIM1_ICPrescaler);
1727  0278 7b06          	ld	a,(OFST+6,sp)
1728  027a cd06d0        	call	_TIM1_SetIC3Prescaler
1731  027d 2012          	jra	L176
1732  027f               L776:
1733                     ; 467         TI4_Config((uint8_t)TIM1_ICPolarity,
1733                     ; 468                    (uint8_t)TIM1_ICSelection,
1733                     ; 469                    (uint8_t)TIM1_ICFilter);
...
1743  028b 84            	pop	a
1744                     ; 471         TIM1_SetIC4Prescaler(TIM1_ICPrescaler);
...
1753  0291 85            	popw	x
1754  0292 81            	ret
1850                     ; 490 void TIM1_PWMIConfig(TIM1_Channel_TypeDef TIM1_Channel,
1850                     ; 491                      TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
1850                     ; 492                      TIM1_ICSelection_TypeDef TIM1_ICSelection,
1850                     ; 493                      TIM1_ICPSC_TypeDef TIM1_ICPrescaler,
1850                     ; 494                      uint8_t TIM1_ICFilter)
1850                     ; 495 {
1851                     	switch	.text
...
1859                     ; 496     uint8_t icpolarity = TIM1_ICPOLARITY_RISING;
1861                     ; 497     uint8_t icselection = TIM1_ICSELECTION_DIRECTTI;
1863                     ; 500     assert_param(IS_TIM1_PWMI_CHANNEL_OK(TIM1_Channel));
1865                     ; 501     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
1867                     ; 502     assert_param(IS_TIM1_IC_SELECTION_OK(TIM1_ICSelection));
1869                     ; 503     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_ICPrescaler));
1871                     ; 506     if (TIM1_ICPolarity != TIM1_ICPOLARITY_FALLING)
1873  0295 9f            	ld	a,xl
1874  0296 a101          	cp	a,#1
1875  0298 2706          	jreq	L157
1876                     ; 508         icpolarity = TIM1_ICPOLARITY_FALLING;
1878  029a a601          	ld	a,#1
1879  029c 6b01          	ld	(OFST-1,sp),a
1882  029e 2002          	jra	L357
1883  02a0               L157:
1884                     ; 512         icpolarity = TIM1_ICPOLARITY_RISING;
1886  02a0 0f01          	clr	(OFST-1,sp)
1888  02a2               L357:
1889                     ; 516     if (TIM1_ICSelection == TIM1_ICSELECTION_DIRECTTI)
1891  02a2 7b07          	ld	a,(OFST+5,sp)
1892  02a4 a101          	cp	a,#1
1893  02a6 2606          	jrne	L557
1894                     ; 518         icselection = TIM1_ICSELECTION_INDIRECTTI;
1896  02a8 a602          	ld	a,#2
1897  02aa 6b02          	ld	(OFST+0,sp),a
1900  02ac 2004          	jra	L757
1901  02ae               L557:
1902                     ; 522         icselection = TIM1_ICSELECTION_DIRECTTI;
1904  02ae a601          	ld	a,#1
1905  02b0 6b02          	ld	(OFST+0,sp),a
1907  02b2               L757:
1908                     ; 525     if (TIM1_Channel == TIM1_CHANNEL_1)
1910  02b2 0d03          	tnz	(OFST+1,sp)
1911  02b4 2626          	jrne	L167
1912                     ; 528         TI1_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSelection,
1912                     ; 529                    (uint8_t)TIM1_ICFilter);
...
1922  02c2 84            	pop	a
1923                     ; 532         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
1925  02c3 7b08          	ld	a,(OFST+6,sp)
1926  02c5 cd06b6        	call	_TIM1_SetIC1Prescaler
1928                     ; 535         TI2_Config(icpolarity, icselection, TIM1_ICFilter);
...
1938  02d4 84            	pop	a
1939                     ; 538         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
1941  02d5 7b08          	ld	a,(OFST+6,sp)
1942  02d7 cd06c3        	call	_TIM1_SetIC2Prescaler
1945  02da 2024          	jra	L367
1946  02dc               L167:
1947                     ; 543         TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSelection,
1947                     ; 544                    (uint8_t)TIM1_ICFilter);
...
1957  02e8 84            	pop	a
1958                     ; 547         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
1960  02e9 7b08          	ld	a,(OFST+6,sp)
1961  02eb cd06c3        	call	_TIM1_SetIC2Prescaler
1963                     ; 550         TI1_Config(icpolarity, icselection, TIM1_ICFilter);
...
1973  02fa 84            	pop	a
1974                     ; 553         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
...
1984  0302 81            	ret
2039                     ; 563 void TIM1_Cmd(FunctionalState NewState)
2039                     ; 564 {
2040                     	switch	.text
2041  0303               _TIM1_Cmd:
2045                     ; 566     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2047                     ; 569     if (NewState != DISABLE)
2049  0303 4d            	tnz	a
2050  0304 2706          	jreq	L3101
2051                     ; 571         TIM1->CR1 |= TIM1_CR1_CEN;
2053  0306 72105250      	bset	21072,#0
2055  030a 2004          	jra	L5101
2056  030c               L3101:
2057                     ; 575         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_CEN);
2059  030c 72115250      	bres	21072,#0
2060  0310               L5101:
2061                     ; 577 }
2064  0310 81            	ret
2100                     ; 585 void TIM1_CtrlPWMOutputs(FunctionalState NewState)
2100                     ; 586 {
2101                     	switch	.text
2102  0311               _TIM1_CtrlPWMOutputs:
2106                     ; 588     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2108                     ; 592     if (NewState != DISABLE)
2110  0311 4d            	tnz	a
2111  0312 2706          	jreq	L5301
2112                     ; 594         TIM1->BKR |= TIM1_BKR_MOE;
2114  0314 721e526d      	bset	21101,#7
2116  0318 2004          	jra	L7301
2117  031a               L5301:
2118                     ; 598         TIM1->BKR &= (uint8_t)(~TIM1_BKR_MOE);
2120  031a 721f526d      	bres	21101,#7
2121  031e               L7301:
2122                     ; 600 }
2125  031e 81            	ret
2232                     ; 619 void TIM1_ITConfig(TIM1_IT_TypeDef  TIM1_IT, FunctionalState NewState)
2232                     ; 620 {
2233                     	switch	.text
2234  031f               _TIM1_ITConfig:
2236  031f 89            	pushw	x
2237       00000000      OFST:	set	0
2240                     ; 622     assert_param(IS_TIM1_IT_OK(TIM1_IT));
2242                     ; 623     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2244                     ; 625     if (NewState != DISABLE)
2246  0320 9f            	ld	a,xl
2247  0321 4d            	tnz	a
2248  0322 2709          	jreq	L7011
2249                     ; 628         TIM1->IER |= (uint8_t)TIM1_IT;
2251  0324 9e            	ld	a,xh
2252  0325 ca5254        	or	a,21076
2253  0328 c75254        	ld	21076,a
2255  032b 2009          	jra	L1111
2256  032d               L7011:
2257                     ; 633         TIM1->IER &= (uint8_t)(~(uint8_t)TIM1_IT);
...
2267  0336 85            	popw	x
2268  0337 81            	ret
2292                     ; 642 void TIM1_InternalClockConfig(void)
2292                     ; 643 {
2293                     	switch	.text
2294  0338               _TIM1_InternalClockConfig:
2298                     ; 645     TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_SMS);
2300  0338 c65252        	ld	a,21074
2301  033b a4f8          	and	a,#248
2302  033d c75252        	ld	21074,a
2303                     ; 646 }
2306  0340 81            	ret
2423                     ; 664 void TIM1_ETRClockMode1Config(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
2423                     ; 665                               TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
2423                     ; 666                               uint8_t ExtTRGFilter)
2423                     ; 667 {
2424                     	switch	.text
2425  0341               _TIM1_ETRClockMode1Config:
2427  0341 89            	pushw	x
2428       00000000      OFST:	set	0
2431                     ; 669     assert_param(IS_TIM1_EXT_PRESCALER_OK(TIM1_ExtTRGPrescaler));
2433                     ; 670     assert_param(IS_TIM1_EXT_POLARITY_OK(TIM1_ExtTRGPolarity));
2435                     ; 673     TIM1_ETRConfig(TIM1_ExtTRGPrescaler, TIM1_ExtTRGPolarity, ExtTRGFilter);
...
2536  0364 84            	pop	a
2537                     ; 708     TIM1->ETR |= TIM1_ETR_ECE;
2539  0365 721c5253      	bset	21075,#6
2540                     ; 709 }
2543  0369 85            	popw	x
2544  036a 81            	ret
2600                     ; 727 void TIM1_ETRConfig(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
2600                     ; 728                     TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
2600                     ; 729                     uint8_t ExtTRGFilter)
2600                     ; 730 {
2601                     	switch	.text
2602  036b               _TIM1_ETRConfig:
2604  036b 89            	pushw	x
2605       00000000      OFST:	set	0
2608                     ; 732     assert_param(IS_TIM1_EXT_TRG_FILTER_OK(ExtTRGFilter));
2610                     ; 734     TIM1->ETR |= (uint8_t)((uint8_t)(TIM1_ExtTRGPrescaler | (uint8_t)TIM1_ExtTRGPolarity )|
2610                     ; 735                       (uint8_t)ExtTRGFilter );
...
2620  0377 85            	popw	x
2621  0378 81            	ret
2710                     ; 753 void TIM1_TIxExternalClockConfig(TIM1_TIxExternalCLK1Source_TypeDef TIM1_TIxExternalCLKSource,
2710                     ; 754                                  TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
2710                     ; 755                                  uint8_t ICFilter)
2710                     ; 756 {
2711                     	switch	.text
2712  0379               _TIM1_TIxExternalClockConfig:
2714  0379 89            	pushw	x
2715       00000000      OFST:	set	0
2718                     ; 758     assert_param(IS_TIM1_TIXCLK_SOURCE_OK(TIM1_TIxExternalCLKSource));
2720                     ; 759     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
2722                     ; 760     assert_param(IS_TIM1_IC_FILTER_OK(ICFilter));
2724                     ; 763     if (TIM1_TIxExternalCLKSource == TIM1_TIXEXTERNALCLK1SOURCE_TI2)
2726  037a 9e            	ld	a,xh
2727  037b a160          	cp	a,#96
2728  037d 260e          	jrne	L1131
2729                     ; 765         TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
...
2741  038d               L1131:
2742                     ; 769         TI1_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
...
2751  0399 84            	pop	a
2752  039a               L3131:
2753                     ; 773     TIM1_SelectInputTrigger((TIM1_TS_TypeDef)TIM1_TIxExternalCLKSource);
2755  039a 7b01          	ld	a,(OFST+1,sp)
2756  039c ad0a          	call	_TIM1_SelectInputTrigger
2758                     ; 776     TIM1->SMCR |= (uint8_t)(TIM1_SLAVEMODE_EXTERNAL1);
...
2766  03a6 85            	popw	x
2767  03a7 81            	ret
2852                     ; 789 void TIM1_SelectInputTrigger(TIM1_TS_TypeDef TIM1_InputTriggerSource)
2852                     ; 790 {
2853                     	switch	.text
2854  03a8               _TIM1_SelectInputTrigger:
2856  03a8 88            	push	a
2857       00000000      OFST:	set	0
2860                     ; 792     assert_param(IS_TIM1_TRIGGER_SELECTION_OK(TIM1_InputTriggerSource));
2862                     ; 795     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_TS)) | (uint8_t)TIM1_InputTriggerSource);
...
2871  03b3 84            	pop	a
2872  03b4 81            	ret
2908                     ; 806 void TIM1_UpdateDisableConfig(FunctionalState NewState)
2908                     ; 807 {
2909                     	switch	.text
2910  03b5               _TIM1_UpdateDisableConfig:
2914                     ; 809     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2916                     ; 812     if (NewState != DISABLE)
2918  03b5 4d            	tnz	a
2919  03b6 2706          	jreq	L1731
2920                     ; 814         TIM1->CR1 |= TIM1_CR1_UDIS;
2922  03b8 72125250      	bset	21072,#1
2924  03bc 2004          	jra	L3731
2925  03be               L1731:
2926                     ; 818         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_UDIS);
2928  03be 72135250      	bres	21072,#1
2929  03c2               L3731:
2930                     ; 820 }
2933  03c2 81            	ret
2991                     ; 830 void TIM1_UpdateRequestConfig(TIM1_UpdateSource_TypeDef TIM1_UpdateSource)
2991                     ; 831 {
2992                     	switch	.text
2993  03c3               _TIM1_UpdateRequestConfig:
2997                     ; 833     assert_param(IS_TIM1_UPDATE_SOURCE_OK(TIM1_UpdateSource));
2999                     ; 836     if (TIM1_UpdateSource != TIM1_UPDATESOURCE_GLOBAL)
3001  03c3 4d            	tnz	a
3002  03c4 2706          	jreq	L3241
3003                     ; 838         TIM1->CR1 |= TIM1_CR1_URS;
3005  03c6 72145250      	bset	21072,#2
3007  03ca 2004          	jra	L5241
3008  03cc               L3241:
3009                     ; 842         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_URS);
3011  03cc 72155250      	bres	21072,#2
3012  03d0               L5241:
3013                     ; 844 }
3016  03d0 81            	ret
3052                     ; 853 void TIM1_SelectHallSensor(FunctionalState NewState)
3052                     ; 854 {
3053                     	switch	.text
3054  03d1               _TIM1_SelectHallSensor:
3058                     ; 856     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
3060                     ; 859     if (NewState != DISABLE)
3062  03d1 4d            	tnz	a
3063  03d2 2706          	jreq	L5441
3064                     ; 861         TIM1->CR2 |= TIM1_CR2_TI1S;
3066  03d4 721e5251      	bset	21073,#7
3068  03d8 2004          	jra	L7441
3069  03da               L5441:
3070                     ; 865         TIM1->CR2 &= (uint8_t)(~TIM1_CR2_TI1S);
3072  03da 721f5251      	bres	21073,#7
3073  03de               L7441:
3074                     ; 867 }
3077  03de 81            	ret
3134                     ; 878 void TIM1_SelectOnePulseMode(TIM1_OPMode_TypeDef TIM1_OPMode)
3134                     ; 879 {
3135                     	switch	.text
3136  03df               _TIM1_SelectOnePulseMode:
3140                     ; 881     assert_param(IS_TIM1_OPM_MODE_OK(TIM1_OPMode));
3142                     ; 884     if (TIM1_OPMode != TIM1_OPMODE_REPETITIVE)
3144  03df 4d            	tnz	a
3145  03e0 2706          	jreq	L7741
3146                     ; 886         TIM1->CR1 |= TIM1_CR1_OPM;
3148  03e2 72165250      	bset	21072,#3
3150  03e6 2004          	jra	L1051
3151  03e8               L7741:
3152                     ; 890         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_OPM);
3154  03e8 72175250      	bres	21072,#3
3155  03ec               L1051:
3156                     ; 893 }
3159  03ec 81            	ret
3257                     ; 909 void TIM1_SelectOutputTrigger(TIM1_TRGOSource_TypeDef TIM1_TRGOSource)
3257                     ; 910 {
3258                     	switch	.text
3259  03ed               _TIM1_SelectOutputTrigger:
3261  03ed 88            	push	a
3262       00000000      OFST:	set	0
3265                     ; 912     assert_param(IS_TIM1_TRGO_SOURCE_OK(TIM1_TRGOSource));
3267                     ; 915     TIM1->CR2 = (uint8_t)((uint8_t)(TIM1->CR2 & (uint8_t)(~TIM1_CR2_MMS)) | 
3267                     ; 916                           (uint8_t) TIM1_TRGOSource);
...
3276  03f8 84            	pop	a
3277  03f9 81            	ret
3351                     ; 929 void TIM1_SelectSlaveMode(TIM1_SlaveMode_TypeDef TIM1_SlaveMode)
3351                     ; 930 {
3352                     	switch	.text
3353  03fa               _TIM1_SelectSlaveMode:
3355  03fa 88            	push	a
3356       00000000      OFST:	set	0
3359                     ; 933     assert_param(IS_TIM1_SLAVE_MODE_OK(TIM1_SlaveMode));
3361                     ; 936     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_SMS)) |
3361                     ; 937                            (uint8_t)TIM1_SlaveMode);
...
3370  0405 84            	pop	a
3371  0406 81            	ret
3407                     ; 947 void TIM1_SelectMasterSlaveMode(FunctionalState NewState)
3407                     ; 948 {
3408                     	switch	.text
3409  0407               _TIM1_SelectMasterSlaveMode:
3413                     ; 950     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
3415                     ; 953     if (NewState != DISABLE)
3417  0407 4d            	tnz	a
3418  0408 2706          	jreq	L3161
3419                     ; 955         TIM1->SMCR |= TIM1_SMCR_MSM;
3421  040a 721e5252      	bset	21074,#7
3423  040e 2004          	jra	L5161
3424  0410               L3161:
3425                     ; 959         TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_MSM);
3427  0410 721f5252      	bres	21074,#7
3428  0414               L5161:
3429                     ; 961 }
3432  0414 81            	ret
3518                     ; 983 void TIM1_EncoderInterfaceConfig(TIM1_EncoderMode_TypeDef TIM1_EncoderMode,
3518                     ; 984                                  TIM1_ICPolarity_TypeDef TIM1_IC1Polarity,
3518                     ; 985                                  TIM1_ICPolarity_TypeDef TIM1_IC2Polarity)
3518                     ; 986 {
3519                     	switch	.text
3520  0415               _TIM1_EncoderInterfaceConfig:
3522  0415 89            	pushw	x
3523       00000000      OFST:	set	0
3526                     ; 990     assert_param(IS_TIM1_ENCODER_MODE_OK(TIM1_EncoderMode));
3528                     ; 991     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_IC1Polarity));
3530                     ; 992     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_IC2Polarity));
3532                     ; 995     if (TIM1_IC1Polarity != TIM1_ICPOLARITY_RISING)
3534  0416 9f            	ld	a,xl
3535  0417 4d            	tnz	a
3536  0418 2706          	jreq	L7561
3537                     ; 997         TIM1->CCER1 |= TIM1_CCER1_CC1P;
3539  041a 7212525c      	bset	21084,#1
3541  041e 2004          	jra	L1661
3542  0420               L7561:
3543                     ; 1001         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
3545  0420 7213525c      	bres	21084,#1
3546  0424               L1661:
3547                     ; 1004     if (TIM1_IC2Polarity != TIM1_ICPOLARITY_RISING)
3549  0424 0d05          	tnz	(OFST+5,sp)
3550  0426 2706          	jreq	L3661
3551                     ; 1006         TIM1->CCER1 |= TIM1_CCER1_CC2P;
3553  0428 721a525c      	bset	21084,#5
3555  042c 2004          	jra	L5661
3556  042e               L3661:
3557                     ; 1010         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
3559  042e 721b525c      	bres	21084,#5
3560  0432               L5661:
3561                     ; 1013     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(TIM1_SMCR_MSM | TIM1_SMCR_TS))
3561                     ; 1014                            | (uint8_t) TIM1_EncoderMode);
3563  0432 c65252        	ld	a,21074
3564  0435 a4f0          	and	a,#240
3565  0437 1a01          	or	a,(OFST+1,sp)
3566  0439 c75252        	ld	21074,a
3567                     ; 1017     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_CCxS)) 
3567                     ; 1018                             | (uint8_t) CCMR_TIxDirect_Set);
3569  043c c65258        	ld	a,21080
3570  043f a4fc          	and	a,#252
3571  0441 aa01          	or	a,#1
3572  0443 c75258        	ld	21080,a
3573                     ; 1019     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_CCxS))
3573                     ; 1020                             | (uint8_t) CCMR_TIxDirect_Set);
...
3582  0450 85            	popw	x
3583  0451 81            	ret
3650                     ; 1035 void TIM1_PrescalerConfig(uint16_t Prescaler,
3650                     ; 1036                           TIM1_PSCReloadMode_TypeDef TIM1_PSCReloadMode)
3650                     ; 1037 {
3651                     	switch	.text
3652  0452               _TIM1_PrescalerConfig:
3654  0452 89            	pushw	x
3655       00000000      OFST:	set	0
3658                     ; 1039     assert_param(IS_TIM1_PRESCALER_RELOAD_OK(TIM1_PSCReloadMode));
3660                     ; 1042     TIM1->PSCRH = (uint8_t)(Prescaler >> 8);
3662  0453 9e            	ld	a,xh
3663  0454 c75260        	ld	21088,a
3664                     ; 1043     TIM1->PSCRL = (uint8_t)(Prescaler);
3666  0457 9f            	ld	a,xl
3667  0458 c75261        	ld	21089,a
3668                     ; 1046     TIM1->EGR = (uint8_t)TIM1_PSCReloadMode;
3670  045b 7b05          	ld	a,(OFST+5,sp)
3671  045d c75257        	ld	21079,a
3672                     ; 1048 }
3675  0460 85            	popw	x
3676  0461 81            	ret
3712                     ; 1061 void TIM1_CounterModeConfig(TIM1_CounterMode_TypeDef TIM1_CounterMode)
3712                     ; 1062 {
3713                     	switch	.text
3714  0462               _TIM1_CounterModeConfig:
3716  0462 88            	push	a
3717       00000000      OFST:	set	0
3720                     ; 1064     assert_param(IS_TIM1_COUNTER_MODE_OK(TIM1_CounterMode));
3722                     ; 1068     TIM1->CR1 = (uint8_t)((uint8_t)(TIM1->CR1 & (uint8_t)((uint8_t)(~TIM1_CR1_CMS) & (uint8_t)(~TIM1_CR1_DIR)))
3722                     ; 1069                           | (uint8_t)TIM1_CounterMode);
...
3731  046d 84            	pop	a
3732  046e 81            	ret
3790                     ; 1081 void TIM1_ForcedOC1Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
3790                     ; 1082 {
3791                     	switch	.text
3792  046f               _TIM1_ForcedOC1Config:
3794  046f 88            	push	a
3795       00000000      OFST:	set	0
3798                     ; 1084     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
3800                     ; 1087     TIM1->CCMR1 =  (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM))|
3800                     ; 1088                              (uint8_t)TIM1_ForcedAction);
...
3809  047a 84            	pop	a
3810  047b 81            	ret
3846                     ; 1100 void TIM1_ForcedOC2Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
3846                     ; 1101 {
3847                     	switch	.text
3848  047c               _TIM1_ForcedOC2Config:
3850  047c 88            	push	a
3851       00000000      OFST:	set	0
3854                     ; 1103     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
3856                     ; 1106     TIM1->CCMR2  =  (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM))
3856                     ; 1107                               | (uint8_t)TIM1_ForcedAction);
...
3865  0487 84            	pop	a
3866  0488 81            	ret
3902                     ; 1120 void TIM1_ForcedOC3Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
3902                     ; 1121 {
3903                     	switch	.text
3904  0489               _TIM1_ForcedOC3Config:
3906  0489 88            	push	a
3907       00000000      OFST:	set	0
3910                     ; 1123     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
3912                     ; 1126     TIM1->CCMR3  =  (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM))  
3912                     ; 1127                               | (uint8_t)TIM1_ForcedAction);
...
3921  0494 84            	pop	a
3922  0495 81            	ret
3958                     ; 1140 void TIM1_ForcedOC4Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
3958                     ; 1141 {
3959                     	switch	.text
3960  0496               _TIM1_ForcedOC4Config:
3962  0496 88            	push	a
3963       00000000      OFST:	set	0
3966                     ; 1143     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
3968                     ; 1146     TIM1->CCMR4  =  (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) 
3968                     ; 1147                               | (uint8_t)TIM1_ForcedAction);
...
3977  04a1 84            	pop	a
3978  04a2 81            	ret
4014                     ; 1157 void TIM1_ARRPreloadConfig(FunctionalState NewState)
4014                     ; 1158 {
4015                     	switch	.text
4016  04a3               _TIM1_ARRPreloadConfig:
4020                     ; 1160     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4022                     ; 1163     if (NewState != DISABLE)
4024  04a3 4d            	tnz	a
4025  04a4 2706          	jreq	L5502
4026                     ; 1165         TIM1->CR1 |= TIM1_CR1_ARPE;
4028  04a6 721e5250      	bset	21072,#7
4030  04aa 2004          	jra	L7502
4031  04ac               L5502:
4032                     ; 1169         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_ARPE);
4034  04ac 721f5250      	bres	21072,#7
4035  04b0               L7502:
4036                     ; 1171 }
4039  04b0 81            	ret
4074                     ; 1180 void TIM1_SelectCOM(FunctionalState NewState)
4074                     ; 1181 {
4075                     	switch	.text
4076  04b1               _TIM1_SelectCOM:
4080                     ; 1183     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4082                     ; 1186     if (NewState != DISABLE)
4084  04b1 4d            	tnz	a
4085  04b2 2706          	jreq	L7702
4086                     ; 1188         TIM1->CR2 |= TIM1_CR2_COMS;
4088  04b4 72145251      	bset	21073,#2
4090  04b8 2004          	jra	L1012
4091  04ba               L7702:
4092                     ; 1192         TIM1->CR2 &= (uint8_t)(~TIM1_CR2_COMS);
4094  04ba 72155251      	bres	21073,#2
4095  04be               L1012:
4096                     ; 1194 }
4099  04be 81            	ret
4135                     ; 1202 void TIM1_CCPreloadControl(FunctionalState NewState)
4135                     ; 1203 {
4136                     	switch	.text
4137  04bf               _TIM1_CCPreloadControl:
4141                     ; 1205     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4143                     ; 1208     if (NewState != DISABLE)
4145  04bf 4d            	tnz	a
4146  04c0 2706          	jreq	L1212
4147                     ; 1210         TIM1->CR2 |= TIM1_CR2_CCPC;
4149  04c2 72105251      	bset	21073,#0
4151  04c6 2004          	jra	L3212
4152  04c8               L1212:
4153                     ; 1214         TIM1->CR2 &= (uint8_t)(~TIM1_CR2_CCPC);
4155  04c8 72115251      	bres	21073,#0
4156  04cc               L3212:
4157                     ; 1216 }
4160  04cc 81            	ret
4196                     ; 1225 void TIM1_OC1PreloadConfig(FunctionalState NewState)
4196                     ; 1226 {
4197                     	switch	.text
4198  04cd               _TIM1_OC1PreloadConfig:
4202                     ; 1228     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4204                     ; 1231     if (NewState != DISABLE)
4206  04cd 4d            	tnz	a
4207  04ce 2706          	jreq	L3412
4208                     ; 1233         TIM1->CCMR1 |= TIM1_CCMR_OCxPE;
4210  04d0 72165258      	bset	21080,#3
4212  04d4 2004          	jra	L5412
4213  04d6               L3412:
4214                     ; 1237         TIM1->CCMR1 &= (uint8_t)(~TIM1_CCMR_OCxPE);
4216  04d6 72175258      	bres	21080,#3
4217  04da               L5412:
4218                     ; 1239 }
4221  04da 81            	ret
4257                     ; 1248 void TIM1_OC2PreloadConfig(FunctionalState NewState)
4257                     ; 1249 {
4258                     	switch	.text
4259  04db               _TIM1_OC2PreloadConfig:
4263                     ; 1251     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4265                     ; 1254     if (NewState != DISABLE)
4267  04db 4d            	tnz	a
4268  04dc 2706          	jreq	L5612
4269                     ; 1256         TIM1->CCMR2 |= TIM1_CCMR_OCxPE;
4271  04de 72165259      	bset	21081,#3
4273  04e2 2004          	jra	L7612
4274  04e4               L5612:
4275                     ; 1260         TIM1->CCMR2 &= (uint8_t)(~TIM1_CCMR_OCxPE);
4277  04e4 72175259      	bres	21081,#3
4278  04e8               L7612:
4279                     ; 1262 }
4282  04e8 81            	ret
4318                     ; 1271 void TIM1_OC3PreloadConfig(FunctionalState NewState)
4318                     ; 1272 {
4319                     	switch	.text
4320  04e9               _TIM1_OC3PreloadConfig:
4324                     ; 1274     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4326                     ; 1277     if (NewState != DISABLE)
4328  04e9 4d            	tnz	a
4329  04ea 2706          	jreq	L7022
4330                     ; 1279         TIM1->CCMR3 |= TIM1_CCMR_OCxPE;
4332  04ec 7216525a      	bset	21082,#3
4334  04f0 2004          	jra	L1122
4335  04f2               L7022:
4336                     ; 1283         TIM1->CCMR3 &= (uint8_t)(~TIM1_CCMR_OCxPE);
4338  04f2 7217525a      	bres	21082,#3
4339  04f6               L1122:
4340                     ; 1285 }
4343  04f6 81            	ret
4379                     ; 1295 void TIM1_OC4PreloadConfig(FunctionalState NewState)
4379                     ; 1296 {
4380                     	switch	.text
4381  04f7               _TIM1_OC4PreloadConfig:
4385                     ; 1298     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4387                     ; 1301     if (NewState != DISABLE)
4389  04f7 4d            	tnz	a
4390  04f8 2706          	jreq	L1322
4391                     ; 1303         TIM1->CCMR4 |= TIM1_CCMR_OCxPE;
4393  04fa 7216525b      	bset	21083,#3
4395  04fe 2004          	jra	L3322
4396  0500               L1322:
4397                     ; 1307         TIM1->CCMR4 &= (uint8_t)(~TIM1_CCMR_OCxPE);
4399  0500 7217525b      	bres	21083,#3
4400  0504               L3322:
4401                     ; 1309 }
4404  0504 81            	ret
4439                     ; 1317 void TIM1_OC1FastConfig(FunctionalState NewState)
4439                     ; 1318 {
4440                     	switch	.text
4441  0505               _TIM1_OC1FastConfig:
4445                     ; 1320     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4447                     ; 1323     if (NewState != DISABLE)
4449  0505 4d            	tnz	a
4450  0506 2706          	jreq	L3522
4451                     ; 1325         TIM1->CCMR1 |= TIM1_CCMR_OCxFE;
4453  0508 72145258      	bset	21080,#2
4455  050c 2004          	jra	L5522
4456  050e               L3522:
4457                     ; 1329         TIM1->CCMR1 &= (uint8_t)(~TIM1_CCMR_OCxFE);
4459  050e 72155258      	bres	21080,#2
4460  0512               L5522:
4461                     ; 1331 }
4464  0512 81            	ret
4499                     ; 1341 void TIM1_OC2FastConfig(FunctionalState NewState)
4499                     ; 1342 {
4500                     	switch	.text
4501  0513               _TIM1_OC2FastConfig:
4505                     ; 1344     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4507                     ; 1347     if (NewState != DISABLE)
4509  0513 4d            	tnz	a
4510  0514 2706          	jreq	L5722
4511                     ; 1349         TIM1->CCMR2 |= TIM1_CCMR_OCxFE;
4513  0516 72145259      	bset	21081,#2
4515  051a 2004          	jra	L7722
4516  051c               L5722:
4517                     ; 1353         TIM1->CCMR2 &= (uint8_t)(~TIM1_CCMR_OCxFE);
4519  051c 72155259      	bres	21081,#2
4520  0520               L7722:
4521                     ; 1355 }
4524  0520 81            	ret
4559                     ; 1364 void TIM1_OC3FastConfig(FunctionalState NewState)
4559                     ; 1365 {
4560                     	switch	.text
4561  0521               _TIM1_OC3FastConfig:
4565                     ; 1367     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4567                     ; 1370     if (NewState != DISABLE)
4569  0521 4d            	tnz	a
4570  0522 2706          	jreq	L7132
4571                     ; 1372         TIM1->CCMR3 |= TIM1_CCMR_OCxFE;
4573  0524 7214525a      	bset	21082,#2
4575  0528 2004          	jra	L1232
4576  052a               L7132:
4577                     ; 1376         TIM1->CCMR3 &= (uint8_t)(~TIM1_CCMR_OCxFE);
4579  052a 7215525a      	bres	21082,#2
4580  052e               L1232:
4581                     ; 1378 }
4584  052e 81            	ret
4619                     ; 1387 void TIM1_OC4FastConfig(FunctionalState NewState)
4619                     ; 1388 {
4620                     	switch	.text
4621  052f               _TIM1_OC4FastConfig:
4625                     ; 1390     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4627                     ; 1393     if (NewState != DISABLE)
4629  052f 4d            	tnz	a
4630  0530 2706          	jreq	L1432
4631                     ; 1395         TIM1->CCMR4 |= TIM1_CCMR_OCxFE;
4633  0532 7214525b      	bset	21083,#2
4635  0536 2004          	jra	L3432
4636  0538               L1432:
4637                     ; 1399         TIM1->CCMR4 &= (uint8_t)(~TIM1_CCMR_OCxFE);
4639  0538 7215525b      	bres	21083,#2
4640  053c               L3432:
4641                     ; 1401 }
4644  053c 81            	ret
4749                     ; 1418 void TIM1_GenerateEvent(TIM1_EventSource_TypeDef TIM1_EventSource)
4749                     ; 1419 {
4750                     	switch	.text
4751  053d               _TIM1_GenerateEvent:
4755                     ; 1421     assert_param(IS_TIM1_EVENT_SOURCE_OK(TIM1_EventSource));
4757                     ; 1424     TIM1->EGR = (uint8_t)TIM1_EventSource;
4759  053d c75257        	ld	21079,a
4760                     ; 1425 }
4763  0540 81            	ret
4799                     ; 1436 void TIM1_OC1PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
4799                     ; 1437 {
4800                     	switch	.text
4801  0541               _TIM1_OC1PolarityConfig:
4805                     ; 1439     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
4807                     ; 1442     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
4809  0541 4d            	tnz	a
4810  0542 2706          	jreq	L5242
4811                     ; 1444         TIM1->CCER1 |= TIM1_CCER1_CC1P;
4813  0544 7212525c      	bset	21084,#1
4815  0548 2004          	jra	L7242
4816  054a               L5242:
4817                     ; 1448         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
4819  054a 7213525c      	bres	21084,#1
4820  054e               L7242:
4821                     ; 1450 }
4824  054e 81            	ret
4860                     ; 1461 void TIM1_OC1NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
4860                     ; 1462 {
4861                     	switch	.text
4862  054f               _TIM1_OC1NPolarityConfig:
4866                     ; 1464     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
4868                     ; 1467     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
4870  054f 4d            	tnz	a
4871  0550 2706          	jreq	L7442
4872                     ; 1469         TIM1->CCER1 |= TIM1_CCER1_CC1NP;
4874  0552 7216525c      	bset	21084,#3
4876  0556 2004          	jra	L1542
4877  0558               L7442:
4878                     ; 1473         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1NP);
4880  0558 7217525c      	bres	21084,#3
4881  055c               L1542:
4882                     ; 1475 }
4885  055c 81            	ret
4921                     ; 1486 void TIM1_OC2PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
4921                     ; 1487 {
4922                     	switch	.text
4923  055d               _TIM1_OC2PolarityConfig:
4927                     ; 1489     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
4929                     ; 1492     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
4931  055d 4d            	tnz	a
4932  055e 2706          	jreq	L1742
4933                     ; 1494         TIM1->CCER1 |= TIM1_CCER1_CC2P;
4935  0560 721a525c      	bset	21084,#5
4937  0564 2004          	jra	L3742
4938  0566               L1742:
4939                     ; 1498         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
4941  0566 721b525c      	bres	21084,#5
4942  056a               L3742:
4943                     ; 1500 }
4946  056a 81            	ret
4982                     ; 1510 void TIM1_OC2NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
4982                     ; 1511 {
4983                     	switch	.text
4984  056b               _TIM1_OC2NPolarityConfig:
4988                     ; 1513     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
4990                     ; 1516     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
4992  056b 4d            	tnz	a
4993  056c 2706          	jreq	L3152
4994                     ; 1518         TIM1->CCER1 |= TIM1_CCER1_CC2NP;
4996  056e 721e525c      	bset	21084,#7
4998  0572 2004          	jra	L5152
4999  0574               L3152:
5000                     ; 1522         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2NP);
5002  0574 721f525c      	bres	21084,#7
5003  0578               L5152:
5004                     ; 1524 }
5007  0578 81            	ret
5043                     ; 1535 void TIM1_OC3PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
5043                     ; 1536 {
5044                     	switch	.text
5045  0579               _TIM1_OC3PolarityConfig:
5049                     ; 1538     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
5051                     ; 1541     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
5053  0579 4d            	tnz	a
5054  057a 2706          	jreq	L5352
5055                     ; 1543         TIM1->CCER2 |= TIM1_CCER2_CC3P;
5057  057c 7212525d      	bset	21085,#1
5059  0580 2004          	jra	L7352
5060  0582               L5352:
5061                     ; 1547         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
5063  0582 7213525d      	bres	21085,#1
5064  0586               L7352:
5065                     ; 1549 }
5068  0586 81            	ret
5104                     ; 1560 void TIM1_OC3NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
5104                     ; 1561 {
5105                     	switch	.text
5106  0587               _TIM1_OC3NPolarityConfig:
5110                     ; 1563     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
5112                     ; 1566     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
5114  0587 4d            	tnz	a
5115  0588 2706          	jreq	L7552
5116                     ; 1568         TIM1->CCER2 |= TIM1_CCER2_CC3NP;
5118  058a 7216525d      	bset	21085,#3
5120  058e 2004          	jra	L1652
5121  0590               L7552:
5122                     ; 1572         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3NP);
5124  0590 7217525d      	bres	21085,#3
5125  0594               L1652:
5126                     ; 1574 }
5129  0594 81            	ret
5165                     ; 1584 void TIM1_OC4PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
5165                     ; 1585 {
5166                     	switch	.text
5167  0595               _TIM1_OC4PolarityConfig:
5171                     ; 1587     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
5173                     ; 1590     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
5175  0595 4d            	tnz	a
5176  0596 2706          	jreq	L1062
5177                     ; 1592         TIM1->CCER2 |= TIM1_CCER2_CC4P;
5179  0598 721a525d      	bset	21085,#5
5181  059c 2004          	jra	L3062
5182  059e               L1062:
5183                     ; 1596         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4P);
5185  059e 721b525d      	bres	21085,#5
5186  05a2               L3062:
5187                     ; 1598 }
5190  05a2 81            	ret
5235                     ; 1613 void TIM1_CCxCmd(TIM1_Channel_TypeDef TIM1_Channel, FunctionalState NewState)
5235                     ; 1614 {
5236                     	switch	.text
5237  05a3               _TIM1_CCxCmd:
5239  05a3 89            	pushw	x
5240       00000000      OFST:	set	0
5243                     ; 1616     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
5245                     ; 1617     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5247                     ; 1619     if (TIM1_Channel == TIM1_CHANNEL_1)
5249  05a4 9e            	ld	a,xh
5250  05a5 4d            	tnz	a
5251  05a6 2610          	jrne	L7262
5252                     ; 1622         if (NewState != DISABLE)
5254  05a8 9f            	ld	a,xl
5255  05a9 4d            	tnz	a
5256  05aa 2706          	jreq	L1362
5257                     ; 1624             TIM1->CCER1 |= TIM1_CCER1_CC1E;
5259  05ac 7210525c      	bset	21084,#0
5261  05b0 2040          	jra	L5362
5262  05b2               L1362:
5263                     ; 1628             TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
5265  05b2 7211525c      	bres	21084,#0
5266  05b6 203a          	jra	L5362
5267  05b8               L7262:
5268                     ; 1632     else if (TIM1_Channel == TIM1_CHANNEL_2)
5270  05b8 7b01          	ld	a,(OFST+1,sp)
5271  05ba a101          	cp	a,#1
5272  05bc 2610          	jrne	L7362
5273                     ; 1635         if (NewState != DISABLE)
5275  05be 0d02          	tnz	(OFST+2,sp)
5276  05c0 2706          	jreq	L1462
5277                     ; 1637             TIM1->CCER1 |= TIM1_CCER1_CC2E;
5279  05c2 7218525c      	bset	21084,#4
5281  05c6 202a          	jra	L5362
5282  05c8               L1462:
5283                     ; 1641             TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2E);
5285  05c8 7219525c      	bres	21084,#4
5286  05cc 2024          	jra	L5362
5287  05ce               L7362:
5288                     ; 1644     else if (TIM1_Channel == TIM1_CHANNEL_3)
5290  05ce 7b01          	ld	a,(OFST+1,sp)
5291  05d0 a102          	cp	a,#2
5292  05d2 2610          	jrne	L7462
5293                     ; 1647         if (NewState != DISABLE)
5295  05d4 0d02          	tnz	(OFST+2,sp)
5296  05d6 2706          	jreq	L1562
5297                     ; 1649             TIM1->CCER2 |= TIM1_CCER2_CC3E;
5299  05d8 7210525d      	bset	21085,#0
5301  05dc 2014          	jra	L5362
5302  05de               L1562:
5303                     ; 1653             TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3E);
5305  05de 7211525d      	bres	21085,#0
5306  05e2 200e          	jra	L5362
5307  05e4               L7462:
5308                     ; 1659         if (NewState != DISABLE)
5310  05e4 0d02          	tnz	(OFST+2,sp)
5311  05e6 2706          	jreq	L7562
5312                     ; 1661             TIM1->CCER2 |= TIM1_CCER2_CC4E;
5314  05e8 7218525d      	bset	21085,#4
5316  05ec 2004          	jra	L5362
5317  05ee               L7562:
5318                     ; 1665             TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4E);
5320  05ee 7219525d      	bres	21085,#4
5321  05f2               L5362:
5322                     ; 1668 }
5325  05f2 85            	popw	x
5326  05f3 81            	ret
5371                     ; 1681 void TIM1_CCxNCmd(TIM1_Channel_TypeDef TIM1_Channel, FunctionalState NewState)
5371                     ; 1682 {
5372                     	switch	.text
5373  05f4               _TIM1_CCxNCmd:
5375  05f4 89            	pushw	x
5376       00000000      OFST:	set	0
5379                     ; 1684     assert_param(IS_TIM1_COMPLEMENTARY_CHANNEL_OK(TIM1_Channel));
5381                     ; 1685     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5383                     ; 1687     if (TIM1_Channel == TIM1_CHANNEL_1)
5385  05f5 9e            	ld	a,xh
5386  05f6 4d            	tnz	a
5387  05f7 2610          	jrne	L5072
5388                     ; 1690         if (NewState != DISABLE)
5390  05f9 9f            	ld	a,xl
5391  05fa 4d            	tnz	a
5392  05fb 2706          	jreq	L7072
5393                     ; 1692             TIM1->CCER1 |= TIM1_CCER1_CC1NE;
5395  05fd 7214525c      	bset	21084,#2
5397  0601 202a          	jra	L3172
5398  0603               L7072:
5399                     ; 1696             TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1NE);
5401  0603 7215525c      	bres	21084,#2
5402  0607 2024          	jra	L3172
5403  0609               L5072:
5404                     ; 1699     else if (TIM1_Channel == TIM1_CHANNEL_2)
5406  0609 7b01          	ld	a,(OFST+1,sp)
5407  060b a101          	cp	a,#1
5408  060d 2610          	jrne	L5172
5409                     ; 1702         if (NewState != DISABLE)
5411  060f 0d02          	tnz	(OFST+2,sp)
5412  0611 2706          	jreq	L7172
5413                     ; 1704             TIM1->CCER1 |= TIM1_CCER1_CC2NE;
5415  0613 721c525c      	bset	21084,#6
5417  0617 2014          	jra	L3172
5418  0619               L7172:
5419                     ; 1708             TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2NE);
5421  0619 721d525c      	bres	21084,#6
5422  061d 200e          	jra	L3172
5423  061f               L5172:
5424                     ; 1714         if (NewState != DISABLE)
5426  061f 0d02          	tnz	(OFST+2,sp)
5427  0621 2706          	jreq	L5272
5428                     ; 1716             TIM1->CCER2 |= TIM1_CCER2_CC3NE;
5430  0623 7214525d      	bset	21085,#2
5432  0627 2004          	jra	L3172
5433  0629               L5272:
5434                     ; 1720             TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3NE);
5436  0629 7215525d      	bres	21085,#2
5437  062d               L3172:
5438                     ; 1723 }
5441  062d 85            	popw	x
5442  062e 81            	ret
5487                     ; 1747 void TIM1_SelectOCxM(TIM1_Channel_TypeDef TIM1_Channel, TIM1_OCMode_TypeDef TIM1_OCMode)
5487                     ; 1748 {
5488                     	switch	.text
5489  062f               _TIM1_SelectOCxM:
5491  062f 89            	pushw	x
5492       00000000      OFST:	set	0
5495                     ; 1750     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
5497                     ; 1751     assert_param(IS_TIM1_OCM_OK(TIM1_OCMode));
5499                     ; 1753     if (TIM1_Channel == TIM1_CHANNEL_1)
5501  0630 9e            	ld	a,xh
5502  0631 4d            	tnz	a
5503  0632 2610          	jrne	L3572
5504                     ; 1756         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
5506  0634 7211525c      	bres	21084,#0
5507                     ; 1759         TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) 
5507                     ; 1760                                 | (uint8_t)TIM1_OCMode);
...
5515  0644               L3572:
5516                     ; 1762     else if (TIM1_Channel == TIM1_CHANNEL_2)
5518  0644 7b01          	ld	a,(OFST+1,sp)
5519  0646 a101          	cp	a,#1
5520  0648 2610          	jrne	L7572
5521                     ; 1765         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2E);
5523  064a 7219525c      	bres	21084,#4
5524                     ; 1768         TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM))
5524                     ; 1769                                 | (uint8_t)TIM1_OCMode);
...
5532  065a               L7572:
5533                     ; 1771     else if (TIM1_Channel == TIM1_CHANNEL_3)
5535  065a 7b01          	ld	a,(OFST+1,sp)
5536  065c a102          	cp	a,#2
5537  065e 2610          	jrne	L3672
5538                     ; 1774         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3E);
5540  0660 7211525d      	bres	21085,#0
5541                     ; 1777         TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) 
5541                     ; 1778                                 | (uint8_t)TIM1_OCMode);
...
5549  0670               L3672:
5550                     ; 1783         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4E);
5552  0670 7219525d      	bres	21085,#4
5553                     ; 1786         TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) 
5553                     ; 1787                                 | (uint8_t)TIM1_OCMode);
...
5563  067e 85            	popw	x
5564  067f 81            	ret
5598                     ; 1798 void TIM1_SetCounter(uint16_t Counter)
5598                     ; 1799 {
5599                     	switch	.text
5600  0680               _TIM1_SetCounter:
5604                     ; 1801     TIM1->CNTRH = (uint8_t)(Counter >> 8);
5606  0680 9e            	ld	a,xh
5607  0681 c7525e        	ld	21086,a
5608                     ; 1802     TIM1->CNTRL = (uint8_t)(Counter);
5610  0684 9f            	ld	a,xl
5611  0685 c7525f        	ld	21087,a
5612                     ; 1804 }
5615  0688 81            	ret
5649                     ; 1813 void TIM1_SetAutoreload(uint16_t Autoreload)
5649                     ; 1814 {
5650                     	switch	.text
5651  0689               _TIM1_SetAutoreload:
5655                     ; 1817     TIM1->ARRH = (uint8_t)(Autoreload >> 8);
5657  0689 9e            	ld	a,xh
5658  068a c75262        	ld	21090,a
5659                     ; 1818     TIM1->ARRL = (uint8_t)(Autoreload);
5661  068d 9f            	ld	a,xl
5662  068e c75263        	ld	21091,a
5663                     ; 1820 }
5666  0691 81            	ret
5700                     ; 1829 void TIM1_SetCompare1(uint16_t Compare1)
5700                     ; 1830 {
5701                     	switch	.text
5702  0692               _TIM1_SetCompare1:
5706                     ; 1832     TIM1->CCR1H = (uint8_t)(Compare1 >> 8);
5708  0692 9e            	ld	a,xh
5709  0693 c75265        	ld	21093,a
5710                     ; 1833     TIM1->CCR1L = (uint8_t)(Compare1);
5712  0696 9f            	ld	a,xl
5713  0697 c75266        	ld	21094,a
5714                     ; 1835 }
5717  069a 81            	ret
5751                     ; 1844 void TIM1_SetCompare2(uint16_t Compare2)
5751                     ; 1845 {
5752                     	switch	.text
5753  069b               _TIM1_SetCompare2:
5757                     ; 1847     TIM1->CCR2H = (uint8_t)(Compare2 >> 8);
5759  069b 9e            	ld	a,xh
5760  069c c75267        	ld	21095,a
5761                     ; 1848     TIM1->CCR2L = (uint8_t)(Compare2);
5763  069f 9f            	ld	a,xl
5764  06a0 c75268        	ld	21096,a
5765                     ; 1850 }
5768  06a3 81            	ret
5802                     ; 1859 void TIM1_SetCompare3(uint16_t Compare3)
5802                     ; 1860 {
5803                     	switch	.text
5804  06a4               _TIM1_SetCompare3:
5808                     ; 1862     TIM1->CCR3H = (uint8_t)(Compare3 >> 8);
5810  06a4 9e            	ld	a,xh
5811  06a5 c75269        	ld	21097,a
5812                     ; 1863     TIM1->CCR3L = (uint8_t)(Compare3);
5814  06a8 9f            	ld	a,xl
5815  06a9 c7526a        	ld	21098,a
5816                     ; 1865 }
5819  06ac 81            	ret
5853                     ; 1874 void TIM1_SetCompare4(uint16_t Compare4)
5853                     ; 1875 {
5854                     	switch	.text
5855  06ad               _TIM1_SetCompare4:
5859                     ; 1877     TIM1->CCR4H = (uint8_t)(Compare4 >> 8);
5861  06ad 9e            	ld	a,xh
5862  06ae c7526b        	ld	21099,a
5863                     ; 1878     TIM1->CCR4L = (uint8_t)(Compare4);
5865  06b1 9f            	ld	a,xl
5866  06b2 c7526c        	ld	21100,a
5867                     ; 1879 }
5870  06b5 81            	ret
5906                     ; 1892 void TIM1_SetIC1Prescaler(TIM1_ICPSC_TypeDef TIM1_IC1Prescaler)
5906                     ; 1893 {
5907                     	switch	.text
5908  06b6               _TIM1_SetIC1Prescaler:
5910  06b6 88            	push	a
5911       00000000      OFST:	set	0
5914                     ; 1895     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC1Prescaler));
5916                     ; 1898     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_ICxPSC)) 
5916                     ; 1899                             | (uint8_t)TIM1_IC1Prescaler);
...
5925  06c1 84            	pop	a
5926  06c2 81            	ret
5962                     ; 1913 void TIM1_SetIC2Prescaler(TIM1_ICPSC_TypeDef TIM1_IC2Prescaler)
5962                     ; 1914 {
5963                     	switch	.text
5964  06c3               _TIM1_SetIC2Prescaler:
5966  06c3 88            	push	a
5967       00000000      OFST:	set	0
5970                     ; 1917     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC2Prescaler));
5972                     ; 1920     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_ICxPSC))
5972                     ; 1921                             | (uint8_t)TIM1_IC2Prescaler);
...
5981  06ce 84            	pop	a
5982  06cf 81            	ret
6018                     ; 1935 void TIM1_SetIC3Prescaler(TIM1_ICPSC_TypeDef TIM1_IC3Prescaler)
6018                     ; 1936 {
6019                     	switch	.text
6020  06d0               _TIM1_SetIC3Prescaler:
6022  06d0 88            	push	a
6023       00000000      OFST:	set	0
6026                     ; 1939     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC3Prescaler));
6028                     ; 1942     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_ICxPSC)) | 
6028                     ; 1943                             (uint8_t)TIM1_IC3Prescaler);
...
6037  06db 84            	pop	a
6038  06dc 81            	ret
6074                     ; 1956 void TIM1_SetIC4Prescaler(TIM1_ICPSC_TypeDef TIM1_IC4Prescaler)
6074                     ; 1957 {
6075                     	switch	.text
6076  06dd               _TIM1_SetIC4Prescaler:
6078  06dd 88            	push	a
6079       00000000      OFST:	set	0
6082                     ; 1960     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC4Prescaler));
6084                     ; 1963     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_ICxPSC)) |
6084                     ; 1964                             (uint8_t)TIM1_IC4Prescaler);
...
6500                     ; 2046     return (uint16_t)tmpccr4;
6502  077d 1e03          	ldw	x,(OFST-1,sp)
6505  077f 5b04          	addw	sp,#4
6506  0781 81            	ret
6540                     ; 2054 uint16_t TIM1_GetCounter(void)
6540                     ; 2055 {
6541                     	switch	.text
6542  0782               _TIM1_GetCounter:
6544  0782 89            	pushw	x
6545       00000002      OFST:	set	2
6548                     ; 2056   uint16_t tmpcntr = 0;
6550                     ; 2058   tmpcntr = ((uint16_t)TIM1->CNTRH << 8);
...
6559                     ; 2061     return (uint16_t)(tmpcntr | (uint16_t)(TIM1->CNTRL));
...
6572  079a 81            	ret
6606                     ; 2069 uint16_t TIM1_GetPrescaler(void)
6606                     ; 2070 {
6607                     	switch	.text
6608  079b               _TIM1_GetPrescaler:
6610  079b 89            	pushw	x
6611       00000002      OFST:	set	2
6614                     ; 2071    uint16_t temp = 0;
6616                     ; 2073    temp = ((uint16_t)TIM1->PSCRH << 8);
...
6625                     ; 2076     return (uint16_t)( temp | (uint16_t)(TIM1->PSCRL));
...
6638  07b3 81            	ret
6812                     ; 2097 FlagStatus TIM1_GetFlagStatus(TIM1_FLAG_TypeDef TIM1_FLAG)
6812                     ; 2098 {
6813                     	switch	.text
...
6821                     ; 2099     FlagStatus bitstatus = RESET;
6823                     ; 2100     uint8_t tim1_flag_l = 0, tim1_flag_h = 0;
6827                     ; 2103     assert_param(IS_TIM1_GET_FLAG_OK(TIM1_FLAG));
6829                     ; 2105     tim1_flag_l = (uint8_t)(TIM1->SR1 & (uint8_t)TIM1_FLAG);
6831  07b6 9f            	ld	a,xl
6832  07b7 c45255        	and	a,21077
6833  07ba 6b01          	ld	(OFST-1,sp),a
6835                     ; 2106     tim1_flag_h = (uint8_t)((uint16_t)TIM1_FLAG >> 8);
6837  07bc 7b03          	ld	a,(OFST+1,sp)
6838  07be 6b02          	ld	(OFST+0,sp),a
6840                     ; 2108     if ((tim1_flag_l | (uint8_t)(TIM1->SR2 & tim1_flag_h)) != 0)
6842  07c0 c65256        	ld	a,21078
6843  07c3 1402          	and	a,(OFST+0,sp)
6844  07c5 1a01          	or	a,(OFST-1,sp)
6845  07c7 2706          	jreq	L5643
6846                     ; 2110         bitstatus = SET;
6848  07c9 a601          	ld	a,#1
6849  07cb 6b02          	ld	(OFST+0,sp),a
6852  07cd 2002          	jra	L7643
6853  07cf               L5643:
6854                     ; 2114         bitstatus = RESET;
6856  07cf 0f02          	clr	(OFST+0,sp)
6858  07d1               L7643:
6859                     ; 2116     return (FlagStatus)(bitstatus);
6861  07d1 7b02          	ld	a,(OFST+0,sp)
6864  07d3 5b04          	addw	sp,#4
6865  07d5 81            	ret
6900                     ; 2137 void TIM1_ClearFlag(TIM1_FLAG_TypeDef TIM1_FLAG)
6900                     ; 2138 {
6901                     	switch	.text
6902  07d6               _TIM1_ClearFlag:
6904  07d6 89            	pushw	x
6905       00000000      OFST:	set	0
6908                     ; 2140     assert_param(IS_TIM1_CLEAR_FLAG_OK(TIM1_FLAG));
6910                     ; 2143     TIM1->SR1 = (uint8_t)(~(uint8_t)(TIM1_FLAG));
6912  07d7 9f            	ld	a,xl
6913  07d8 43            	cpl	a
6914  07d9 c75255        	ld	21077,a
6915                     ; 2144     TIM1->SR2 = (uint8_t)((uint8_t)(~((uint8_t)((uint16_t)TIM1_FLAG >> 8))) & 
6915                     ; 2145                           (uint8_t)0x1E);
...
7011                     ; 2172     TIM1_itEnable = (uint8_t)(TIM1->IER & (uint8_t)TIM1_IT);
7013  07ed c65254        	ld	a,21076
7014  07f0 1403          	and	a,(OFST+1,sp)
7015  07f2 6b02          	ld	(OFST+0,sp),a
7017                     ; 2174     if ((TIM1_itStatus != (uint8_t)RESET ) && (TIM1_itEnable != (uint8_t)RESET ))
7019  07f4 0d01          	tnz	(OFST-1,sp)
7020  07f6 270a          	jreq	L1453
7022  07f8 0d02          	tnz	(OFST+0,sp)
7023  07fa 2706          	jreq	L1453
7024                     ; 2176         bitstatus = SET;
7026  07fc a601          	ld	a,#1
7027  07fe 6b02          	ld	(OFST+0,sp),a
7030  0800 2002          	jra	L3453
7031  0802               L1453:
7032                     ; 2180         bitstatus = RESET;
7034  0802 0f02          	clr	(OFST+0,sp)
7036  0804               L3453:
7037                     ; 2182     return (ITStatus)(bitstatus);
7039  0804 7b02          	ld	a,(OFST+0,sp)
7042  0806 5b03          	addw	sp,#3
7043  0808 81            	ret
7079                     ; 2199 void TIM1_ClearITPendingBit(TIM1_IT_TypeDef TIM1_IT)
7079                     ; 2200 {
7080                     	switch	.text
7081  0809               _TIM1_ClearITPendingBit:
7085                     ; 2202     assert_param(IS_TIM1_IT_OK(TIM1_IT));
7087                     ; 2205     TIM1->SR1 = (uint8_t)(~(uint8_t)TIM1_IT);
7089  0809 43            	cpl	a
7090  080a c75255        	ld	21077,a
7091                     ; 2206 }
7094  080d 81            	ret
7146                     ; 2224 static void TI1_Config(uint8_t TIM1_ICPolarity,
7146                     ; 2225                        uint8_t TIM1_ICSelection,
7146                     ; 2226                        uint8_t TIM1_ICFilter)
7146                     ; 2227 {
7147                     	switch	.text
...
7155                     ; 2230     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
7157  0810 7211525c      	bres	21084,#0
7158                     ; 2233     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF ))) | 
7158                     ; 2234                             (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
7172                     ; 2237     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
7174  0829 0d02          	tnz	(OFST+1,sp)
7175  082b 2706          	jreq	L1163
7176                     ; 2239         TIM1->CCER1 |= TIM1_CCER1_CC1P;
7178  082d 7212525c      	bset	21084,#1
7180  0831 2004          	jra	L3163
7181  0833               L1163:
7182                     ; 2243         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
7184  0833 7213525c      	bres	21084,#1
7185  0837               L3163:
7186                     ; 2247     TIM1->CCER1 |=  TIM1_CCER1_CC1E;
7188  0837 7210525c      	bset	21084,#0
7189                     ; 2248 }
7192  083b 5b03          	addw	sp,#3
7193  083d 81            	ret
7245                     ; 2266 static void TI2_Config(uint8_t TIM1_ICPolarity,
7245                     ; 2267                        uint8_t TIM1_ICSelection,
7245                     ; 2268                        uint8_t TIM1_ICFilter)
7245                     ; 2269 {
7246                     	switch	.text
...
7254                     ; 2271     TIM1->CCER1 &=  (uint8_t)(~TIM1_CCER1_CC2E);
7256  0840 7219525c      	bres	21084,#4
7257                     ; 2274     TIM1->CCMR2  = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF ))) 
7257                     ; 2275                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
7271                     ; 2277     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
7273  0859 0d02          	tnz	(OFST+1,sp)
7274  085b 2706          	jreq	L3463
7275                     ; 2279         TIM1->CCER1 |= TIM1_CCER1_CC2P;
7277  085d 721a525c      	bset	21084,#5
7279  0861 2004          	jra	L5463
7280  0863               L3463:
7281                     ; 2283         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
7283  0863 721b525c      	bres	21084,#5
7284  0867               L5463:
7285                     ; 2286     TIM1->CCER1 |=  TIM1_CCER1_CC2E;
7287  0867 7218525c      	bset	21084,#4
7288                     ; 2287 }
7291  086b 5b03          	addw	sp,#3
7292  086d 81            	ret
7344                     ; 2305 static void TI3_Config(uint8_t TIM1_ICPolarity,
7344                     ; 2306                        uint8_t TIM1_ICSelection,
7344                     ; 2307                        uint8_t TIM1_ICFilter)
7344                     ; 2308 {
7345                     	switch	.text
...
7353                     ; 2310     TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC3E);
7355  0870 7211525d      	bres	21085,#0
7356                     ; 2313     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF))) 
7356                     ; 2314                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
7370                     ; 2317     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
7372  0889 0d02          	tnz	(OFST+1,sp)
7373  088b 2706          	jreq	L5763
7374                     ; 2319         TIM1->CCER2 |= TIM1_CCER2_CC3P;
7376  088d 7212525d      	bset	21085,#1
7378  0891 2004          	jra	L7763
7379  0893               L5763:
7380                     ; 2323         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
7382  0893 7213525d      	bres	21085,#1
7383  0897               L7763:
7384                     ; 2326     TIM1->CCER2 |=  TIM1_CCER2_CC3E;
7386  0897 7210525d      	bset	21085,#0
7387                     ; 2327 }
7390  089b 5b03          	addw	sp,#3
7391  089d 81            	ret
7443                     ; 2346 static void TI4_Config(uint8_t TIM1_ICPolarity,
7443                     ; 2347                        uint8_t TIM1_ICSelection,
7443                     ; 2348                        uint8_t TIM1_ICFilter)
7443                     ; 2349 {
7444                     	switch	.text
...
7452                     ; 2352     TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC4E);
7454  08a0 7219525d      	bres	21085,#4
7455                     ; 2355     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF )))
7455                     ; 2356                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
7469                     ; 2359     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
7471  08b9 0d02          	tnz	(OFST+1,sp)
7472  08bb 2706          	jreq	L7273
7473                     ; 2361         TIM1->CCER2 |= TIM1_CCER2_CC4P;
7475  08bd 721a525d      	bset	21085,#5
7477  08c1 2004          	jra	L1373
7478  08c3               L7273:
7479                     ; 2365         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4P);
7481  08c3 721b525d      	bres	21085,#5
7482  08c7               L1373:
7483                     ; 2369     TIM1->CCER2 |=  TIM1_CCER2_CC4E;
