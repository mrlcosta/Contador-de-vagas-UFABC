  ...
  42                     ; 45 void TIM3_DeInit(void)
  42                     ; 46 {
  44                     	switch	.text
  45  0000               _TIM3_DeInit:
  49                     ; 48     TIM3->CR1 = (uint8_t)TIM3_CR1_RESET_VALUE;
  51  0000 725f5320      	clr	21280
  52                     ; 49     TIM3->IER = (uint8_t)TIM3_IER_RESET_VALUE;
  54  0004 725f5321      	clr	21281
  55                     ; 50     TIM3->SR2 = (uint8_t)TIM3_SR2_RESET_VALUE;
  57  0008 725f5323      	clr	21283
  58                     ; 53     TIM3->CCER1 = (uint8_t)TIM3_CCER1_RESET_VALUE;
  60  000c 725f5327      	clr	21287
  61                     ; 56     TIM3->CCER1 = (uint8_t)TIM3_CCER1_RESET_VALUE;
  63  0010 725f5327      	clr	21287
  64                     ; 57     TIM3->CCMR1 = (uint8_t)TIM3_CCMR1_RESET_VALUE;
  66  0014 725f5325      	clr	21285
  67                     ; 58     TIM3->CCMR2 = (uint8_t)TIM3_CCMR2_RESET_VALUE;
  69  0018 725f5326      	clr	21286
  70                     ; 59     TIM3->CNTRH = (uint8_t)TIM3_CNTRH_RESET_VALUE;
  72  001c 725f5328      	clr	21288
  73                     ; 60     TIM3->CNTRL = (uint8_t)TIM3_CNTRL_RESET_VALUE;
  75  0020 725f5329      	clr	21289
  76                     ; 61     TIM3->PSCR = (uint8_t)TIM3_PSCR_RESET_VALUE;
  78  0024 725f532a      	clr	21290
  79                     ; 62     TIM3->ARRH  = (uint8_t)TIM3_ARRH_RESET_VALUE;
  81  0028 35ff532b      	mov	21291,#255
  82                     ; 63     TIM3->ARRL  = (uint8_t)TIM3_ARRL_RESET_VALUE;
  84  002c 35ff532c      	mov	21292,#255
  85                     ; 64     TIM3->CCR1H = (uint8_t)TIM3_CCR1H_RESET_VALUE;
  87  0030 725f532d      	clr	21293
  88                     ; 65     TIM3->CCR1L = (uint8_t)TIM3_CCR1L_RESET_VALUE;
  90  0034 725f532e      	clr	21294
  91                     ; 66     TIM3->CCR2H = (uint8_t)TIM3_CCR2H_RESET_VALUE;
  93  0038 725f532f      	clr	21295
  94                     ; 67     TIM3->CCR2L = (uint8_t)TIM3_CCR2L_RESET_VALUE;
  96  003c 725f5330      	clr	21296
  97                     ; 68     TIM3->SR1 = (uint8_t)TIM3_SR1_RESET_VALUE;
  99  0040 725f5322      	clr	21282
 100                     ; 69 }
 103  0044 81            	ret
 271                     ; 78 void TIM3_TimeBaseInit( TIM3_Prescaler_TypeDef TIM3_Prescaler,
 271                     ; 79                         uint16_t TIM3_Period)
 271                     ; 80 {
 272                     	switch	.text
 273  0045               _TIM3_TimeBaseInit:
 275  0045 88            	push	a
 276       00000000      OFST:	set	0
 279                     ; 82     TIM3->PSCR = (uint8_t)(TIM3_Prescaler);
 281  0046 c7532a        	ld	21290,a
 282                     ; 84     TIM3->ARRH = (uint8_t)(TIM3_Period >> 8);
 284  0049 7b04          	ld	a,(OFST+4,sp)
 285  004b c7532b        	ld	21291,a
 286                     ; 85     TIM3->ARRL = (uint8_t)(TIM3_Period);
 288  004e 7b05          	ld	a,(OFST+5,sp)
 289  0050 c7532c        	ld	21292,a
 290                     ; 86 }
 293  0053 84            	pop	a
 294  0054 81            	ret
 451                     ; 96 void TIM3_OC1Init(TIM3_OCMode_TypeDef TIM3_OCMode,
 451                     ; 97                   TIM3_OutputState_TypeDef TIM3_OutputState,
 451                     ; 98                   uint16_t TIM3_Pulse,
 451                     ; 99                   TIM3_OCPolarity_TypeDef TIM3_OCPolarity)
 451                     ; 100 {
 452                     	switch	.text
 ...
 460                     ; 102     assert_param(IS_TIM3_OC_MODE_OK(TIM3_OCMode));
 462                     ; 103     assert_param(IS_TIM3_OUTPUT_STATE_OK(TIM3_OutputState));
 464                     ; 104     assert_param(IS_TIM3_OC_POLARITY_OK(TIM3_OCPolarity));
 466                     ; 107     TIM3->CCER1 &= (uint8_t)(~( TIM3_CCER1_CC1E | TIM3_CCER1_CC1P));
 468  0057 c65327        	ld	a,21287
 469  005a a4fc          	and	a,#252
 470  005c c75327        	ld	21287,a
 471                     ; 109     TIM3->CCER1 |= (uint8_t)((uint8_t)(TIM3_OutputState  & TIM3_CCER1_CC1E   ) | (uint8_t)(TIM3_OCPolarity   & TIM3_CCER1_CC1P   ));
 ...
 482                     ; 112     TIM3->CCMR1 = (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~TIM3_CCMR_OCM)) | (uint8_t)TIM3_OCMode);
 484  0070 c65325        	ld	a,21285
 485  0073 a48f          	and	a,#143
 486  0075 1a02          	or	a,(OFST+1,sp)
 487  0077 c75325        	ld	21285,a
 488                     ; 115     TIM3->CCR1H = (uint8_t)(TIM3_Pulse >> 8);
 490  007a 7b06          	ld	a,(OFST+5,sp)
 491  007c c7532d        	ld	21293,a
 492                     ; 116     TIM3->CCR1L = (uint8_t)(TIM3_Pulse);
 494  007f 7b07          	ld	a,(OFST+6,sp)
 495  0081 c7532e        	ld	21294,a
 496                     ; 117 }
 499  0084 5b03          	addw	sp,#3
 500  0086 81            	ret
 564                     ; 128 void TIM3_OC2Init(TIM3_OCMode_TypeDef TIM3_OCMode,
 564                     ; 129                   TIM3_OutputState_TypeDef TIM3_OutputState,
 564                     ; 130                   uint16_t TIM3_Pulse,
 564                     ; 131                   TIM3_OCPolarity_TypeDef TIM3_OCPolarity)
 564                     ; 132 {
 565                     	switch	.text
 ...
 573                     ; 134     assert_param(IS_TIM3_OC_MODE_OK(TIM3_OCMode));
 575                     ; 135     assert_param(IS_TIM3_OUTPUT_STATE_OK(TIM3_OutputState));
 577                     ; 136     assert_param(IS_TIM3_OC_POLARITY_OK(TIM3_OCPolarity));
 579                     ; 140     TIM3->CCER1 &= (uint8_t)(~( TIM3_CCER1_CC2E |  TIM3_CCER1_CC2P ));
 581  0089 c65327        	ld	a,21287
 582  008c a4cf          	and	a,#207
 583  008e c75327        	ld	21287,a
 584                     ; 142     TIM3->CCER1 |= (uint8_t)((uint8_t)(TIM3_OutputState  & TIM3_CCER1_CC2E   ) | (uint8_t)(TIM3_OCPolarity   & TIM3_CCER1_CC2P ));
 ...
 595                     ; 146     TIM3->CCMR2 = (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~TIM3_CCMR_OCM)) | (uint8_t)TIM3_OCMode);
 597  00a2 c65326        	ld	a,21286
 598  00a5 a48f          	and	a,#143
 599  00a7 1a02          	or	a,(OFST+1,sp)
 600  00a9 c75326        	ld	21286,a
 601                     ; 150     TIM3->CCR2H = (uint8_t)(TIM3_Pulse >> 8);
 603  00ac 7b06          	ld	a,(OFST+5,sp)
 604  00ae c7532f        	ld	21295,a
 605                     ; 151     TIM3->CCR2L = (uint8_t)(TIM3_Pulse);
 607  00b1 7b07          	ld	a,(OFST+6,sp)
 608  00b3 c75330        	ld	21296,a
 609                     ; 152 }
 612  00b6 5b03          	addw	sp,#3
 613  00b8 81            	ret
 797                     ; 163 void TIM3_ICInit(TIM3_Channel_TypeDef TIM3_Channel,
 797                     ; 164                  TIM3_ICPolarity_TypeDef TIM3_ICPolarity,
 797                     ; 165                  TIM3_ICSelection_TypeDef TIM3_ICSelection,
 797                     ; 166                  TIM3_ICPSC_TypeDef TIM3_ICPrescaler,
 797                     ; 167                  uint8_t TIM3_ICFilter)
 797                     ; 168 {
 798                     	switch	.text
 799  00b9               _TIM3_ICInit:
 801  00b9 89            	pushw	x
 802       00000000      OFST:	set	0
 805                     ; 170     assert_param(IS_TIM3_CHANNEL_OK(TIM3_Channel));
 807                     ; 171     assert_param(IS_TIM3_IC_POLARITY_OK(TIM3_ICPolarity));
 809                     ; 172     assert_param(IS_TIM3_IC_SELECTION_OK(TIM3_ICSelection));
 811                     ; 173     assert_param(IS_TIM3_IC_PRESCALER_OK(TIM3_ICPrescaler));
 813                     ; 174     assert_param(IS_TIM3_IC_FILTER_OK(TIM3_ICFilter));
 815                     ; 176     if (TIM3_Channel != TIM3_CHANNEL_2)
 817  00ba 9e            	ld	a,xh
 818  00bb a101          	cp	a,#1
 819  00bd 2714          	jreq	L343
 820                     ; 179         TI1_Config((uint8_t)TIM3_ICPolarity,
 820                     ; 180                    (uint8_t)TIM3_ICSelection,
 820                     ; 181                    (uint8_t)TIM3_ICFilter);
 ...
 830  00cb 84            	pop	a
 831                     ; 184         TIM3_SetIC1Prescaler(TIM3_ICPrescaler);
 833  00cc 7b06          	ld	a,(OFST+6,sp)
 834  00ce cd0285        	call	_TIM3_SetIC1Prescaler
 837  00d1 2012          	jra	L543
 838  00d3               L343:
 839                     ; 189         TI2_Config((uint8_t)TIM3_ICPolarity,
 839                     ; 190                    (uint8_t)TIM3_ICSelection,
 839                     ; 191                    (uint8_t)TIM3_ICFilter);
 ...
 849  00df 84            	pop	a
 850                     ; 194         TIM3_SetIC2Prescaler(TIM3_ICPrescaler);
 ...
 859  00e5 85            	popw	x
 860  00e6 81            	ret
 956                     ; 206 void TIM3_PWMIConfig(TIM3_Channel_TypeDef TIM3_Channel,
 956                     ; 207                      TIM3_ICPolarity_TypeDef TIM3_ICPolarity,
 956                     ; 208                      TIM3_ICSelection_TypeDef TIM3_ICSelection,
 956                     ; 209                      TIM3_ICPSC_TypeDef TIM3_ICPrescaler,
 956                     ; 210                      uint8_t TIM3_ICFilter)
 956                     ; 211 {
 957                     	switch	.text
 ...
 965                     ; 212     uint8_t icpolarity = (uint8_t)TIM3_ICPOLARITY_RISING;
 967                     ; 213     uint8_t icselection = (uint8_t)TIM3_ICSELECTION_DIRECTTI;
 969                     ; 216     assert_param(IS_TIM3_PWMI_CHANNEL_OK(TIM3_Channel));
 971                     ; 217     assert_param(IS_TIM3_IC_POLARITY_OK(TIM3_ICPolarity));
 973                     ; 218     assert_param(IS_TIM3_IC_SELECTION_OK(TIM3_ICSelection));
 975                     ; 219     assert_param(IS_TIM3_IC_PRESCALER_OK(TIM3_ICPrescaler));
 977                     ; 222     if (TIM3_ICPolarity != TIM3_ICPOLARITY_FALLING)
 979  00e9 9f            	ld	a,xl
 980  00ea a144          	cp	a,#68
 981  00ec 2706          	jreq	L514
 982                     ; 224         icpolarity = (uint8_t)TIM3_ICPOLARITY_FALLING;
 984  00ee a644          	ld	a,#68
 985  00f0 6b01          	ld	(OFST-1,sp),a
 988  00f2 2002          	jra	L714
 989  00f4               L514:
 990                     ; 228         icpolarity = (uint8_t)TIM3_ICPOLARITY_RISING;
...
1013  0106               L324:
1014                     ; 241     if (TIM3_Channel != TIM3_CHANNEL_2)
1016  0106 7b03          	ld	a,(OFST+1,sp)
1017  0108 a101          	cp	a,#1
1018  010a 2726          	jreq	L524
1019                     ; 244         TI1_Config((uint8_t)TIM3_ICPolarity, (uint8_t)TIM3_ICSelection,
1019                     ; 245                    (uint8_t)TIM3_ICFilter);
...
1029  0118 84            	pop	a
1030                     ; 248         TIM3_SetIC1Prescaler(TIM3_ICPrescaler);
1032  0119 7b08          	ld	a,(OFST+6,sp)
1033  011b cd0285        	call	_TIM3_SetIC1Prescaler
1035                     ; 251         TI2_Config(icpolarity, icselection, TIM3_ICFilter);
...
1045  012a 84            	pop	a
1046                     ; 254         TIM3_SetIC2Prescaler(TIM3_ICPrescaler);
1048  012b 7b08          	ld	a,(OFST+6,sp)
1049  012d cd0292        	call	_TIM3_SetIC2Prescaler
1052  0130 2024          	jra	L724
1053  0132               L524:
1054                     ; 259         TI2_Config((uint8_t)TIM3_ICPolarity, (uint8_t)TIM3_ICSelection,
1054                     ; 260                    (uint8_t)TIM3_ICFilter);
...
1064  013e 84            	pop	a
1065                     ; 263         TIM3_SetIC2Prescaler(TIM3_ICPrescaler);
1067  013f 7b08          	ld	a,(OFST+6,sp)
1068  0141 cd0292        	call	_TIM3_SetIC2Prescaler
1070                     ; 266         TI1_Config(icpolarity, icselection, TIM3_ICFilter);
...
1080  0150 84            	pop	a
1081                     ; 269         TIM3_SetIC1Prescaler(TIM3_ICPrescaler);
...
1091  0158 81            	ret
1146                     ; 280 void TIM3_Cmd(FunctionalState NewState)
1146                     ; 281 {
1147                     	switch	.text
1148  0159               _TIM3_Cmd:
1152                     ; 283     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1154                     ; 286     if (NewState != DISABLE)
1156  0159 4d            	tnz	a
1157  015a 2706          	jreq	L754
1158                     ; 288         TIM3->CR1 |= (uint8_t)TIM3_CR1_CEN;
...
1168                     ; 294 }
1171  0166 81            	ret
1243                     ; 309 void TIM3_ITConfig(TIM3_IT_TypeDef TIM3_IT, FunctionalState NewState)
1243                     ; 310 {
1244                     	switch	.text
1245  0167               _TIM3_ITConfig:
1247  0167 89            	pushw	x
1248       00000000      OFST:	set	0
1251                     ; 312     assert_param(IS_TIM3_IT_OK(TIM3_IT));
1253                     ; 313     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1255                     ; 315     if (NewState != DISABLE)
1257  0168 9f            	ld	a,xl
1258  0169 4d            	tnz	a
1259  016a 2709          	jreq	L715
1260                     ; 318         TIM3->IER |= (uint8_t)TIM3_IT;
1262  016c 9e            	ld	a,xh
1263  016d ca5321        	or	a,21281
1264  0170 c75321        	ld	21281,a
1266  0173 2009          	jra	L125
1267  0175               L715:
1268                     ; 323         TIM3->IER &= (uint8_t)(~TIM3_IT);
...
1278  017e 85            	popw	x
1279  017f 81            	ret
1315                     ; 334 void TIM3_UpdateDisableConfig(FunctionalState NewState)
1315                     ; 335 {
1316                     	switch	.text
1317  0180               _TIM3_UpdateDisableConfig:
1321                     ; 337     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1323                     ; 340     if (NewState != DISABLE)
1325  0180 4d            	tnz	a
1326  0181 2706          	jreq	L145
1327                     ; 342         TIM3->CR1 |= TIM3_CR1_UDIS;
1329  0183 72125320      	bset	21280,#1
1331  0187 2004          	jra	L345
1332  0189               L145:
1333                     ; 346         TIM3->CR1 &= (uint8_t)(~TIM3_CR1_UDIS);
1335  0189 72135320      	bres	21280,#1
1336  018d               L345:
1337                     ; 348 }
1340  018d 81            	ret
1398                     ; 358 void TIM3_UpdateRequestConfig(TIM3_UpdateSource_TypeDef TIM3_UpdateSource)
1398                     ; 359 {
1399                     	switch	.text
1400  018e               _TIM3_UpdateRequestConfig:
1404                     ; 361     assert_param(IS_TIM3_UPDATE_SOURCE_OK(TIM3_UpdateSource));
1406                     ; 364     if (TIM3_UpdateSource != TIM3_UPDATESOURCE_GLOBAL)
1408  018e 4d            	tnz	a
1409  018f 2706          	jreq	L375
1410                     ; 366         TIM3->CR1 |= TIM3_CR1_URS;
1412  0191 72145320      	bset	21280,#2
1414  0195 2004          	jra	L575
1415  0197               L375:
1416                     ; 370         TIM3->CR1 &= (uint8_t)(~TIM3_CR1_URS);
...
1502                     ; 398 }
1505  01a9 81            	ret
1573                     ; 429 void TIM3_PrescalerConfig(TIM3_Prescaler_TypeDef Prescaler,
1573                     ; 430                           TIM3_PSCReloadMode_TypeDef TIM3_PSCReloadMode)
1573                     ; 431 {
1574                     	switch	.text
1575  01aa               _TIM3_PrescalerConfig:
1579                     ; 433     assert_param(IS_TIM3_PRESCALER_RELOAD_OK(TIM3_PSCReloadMode));
1581                     ; 434     assert_param(IS_TIM3_PRESCALER_OK(Prescaler));
1583                     ; 437     TIM3->PSCR = (uint8_t)Prescaler;
1585  01aa 9e            	ld	a,xh
1586  01ab c7532a        	ld	21290,a
1587                     ; 440     TIM3->EGR = (uint8_t)TIM3_PSCReloadMode;
1589  01ae 9f            	ld	a,xl
1590  01af c75324        	ld	21284,a
1591                     ; 441 }
1594  01b2 81            	ret
1652                     ; 452 void TIM3_ForcedOC1Config(TIM3_ForcedAction_TypeDef TIM3_ForcedAction)
1652                     ; 453 {
1653                     	switch	.text
1654  01b3               _TIM3_ForcedOC1Config:
1656  01b3 88            	push	a
1657       00000000      OFST:	set	0
1660                     ; 455     assert_param(IS_TIM3_FORCED_ACTION_OK(TIM3_ForcedAction));
1662                     ; 458     TIM3->CCMR1 =  (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~TIM3_CCMR_OCM))  | (uint8_t)TIM3_ForcedAction);
...
1671  01be 84            	pop	a
1672  01bf 81            	ret
1708                     ; 470 void TIM3_ForcedOC2Config(TIM3_ForcedAction_TypeDef TIM3_ForcedAction)
1708                     ; 471 {
1709                     	switch	.text
1710  01c0               _TIM3_ForcedOC2Config:
1712  01c0 88            	push	a
1713       00000000      OFST:	set	0
1716                     ; 473     assert_param(IS_TIM3_FORCED_ACTION_OK(TIM3_ForcedAction));
1718                     ; 476     TIM3->CCMR2 =  (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~TIM3_CCMR_OCM)) | (uint8_t)TIM3_ForcedAction);
...
1727  01cb 84            	pop	a
1728  01cc 81            	ret
1764                     ; 486 void TIM3_ARRPreloadConfig(FunctionalState NewState)
1764                     ; 487 {
1765                     	switch	.text
1766  01cd               _TIM3_ARRPreloadConfig:
1770                     ; 489     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1772                     ; 492     if (NewState != DISABLE)
1774  01cd 4d            	tnz	a
1775  01ce 2706          	jreq	L547
1776                     ; 494         TIM3->CR1 |= TIM3_CR1_ARPE;
1778  01d0 721e5320      	bset	21280,#7
1780  01d4 2004          	jra	L747
1781  01d6               L547:
1782                     ; 498         TIM3->CR1 &= (uint8_t)(~TIM3_CR1_ARPE);
1784  01d6 721f5320      	bres	21280,#7
1785  01da               L747:
1786                     ; 500 }
1789  01da 81            	ret
1825                     ; 509 void TIM3_OC1PreloadConfig(FunctionalState NewState)
1825                     ; 510 {
1826                     	switch	.text
1827  01db               _TIM3_OC1PreloadConfig:
1831                     ; 512     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1833                     ; 515     if (NewState != DISABLE)
1835  01db 4d            	tnz	a
1836  01dc 2706          	jreq	L767
1837                     ; 517         TIM3->CCMR1 |= TIM3_CCMR_OCxPE;
1839  01de 72165325      	bset	21285,#3
1841  01e2 2004          	jra	L177
1842  01e4               L767:
1843                     ; 521         TIM3->CCMR1 &= (uint8_t)(~TIM3_CCMR_OCxPE);
1845  01e4 72175325      	bres	21285,#3
1846  01e8               L177:
1847                     ; 523 }
1850  01e8 81            	ret
1886                     ; 532 void TIM3_OC2PreloadConfig(FunctionalState NewState)
1886                     ; 533 {
1887                     	switch	.text
1888  01e9               _TIM3_OC2PreloadConfig:
1892                     ; 535     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1894                     ; 538     if (NewState != DISABLE)
1896  01e9 4d            	tnz	a
1897  01ea 2706          	jreq	L1101
1898                     ; 540         TIM3->CCMR2 |= TIM3_CCMR_OCxPE;
1900  01ec 72165326      	bset	21286,#3
1902  01f0 2004          	jra	L3101
1903  01f2               L1101:
1904                     ; 544         TIM3->CCMR2 &= (uint8_t)(~TIM3_CCMR_OCxPE);
1906  01f2 72175326      	bres	21286,#3
1907  01f6               L3101:
1908                     ; 546 }
1911  01f6 81            	ret
1976                     ; 557 void TIM3_GenerateEvent(TIM3_EventSource_TypeDef TIM3_EventSource)
1976                     ; 558 {
1977                     	switch	.text
1978  01f7               _TIM3_GenerateEvent:
1982                     ; 560     assert_param(IS_TIM3_EVENT_SOURCE_OK(TIM3_EventSource));
1984                     ; 563     TIM3->EGR = (uint8_t)TIM3_EventSource;
1986  01f7 c75324        	ld	21284,a
1987                     ; 564 }
1990  01fa 81            	ret
2026                     ; 575 void TIM3_OC1PolarityConfig(TIM3_OCPolarity_TypeDef TIM3_OCPolarity)
2026                     ; 576 {
2027                     	switch	.text
2028  01fb               _TIM3_OC1PolarityConfig:
2032                     ; 578     assert_param(IS_TIM3_OC_POLARITY_OK(TIM3_OCPolarity));
2034                     ; 581     if (TIM3_OCPolarity != TIM3_OCPOLARITY_HIGH)
2036  01fb 4d            	tnz	a
2037  01fc 2706          	jreq	L3601
2038                     ; 583         TIM3->CCER1 |= TIM3_CCER1_CC1P;
2040  01fe 72125327      	bset	21287,#1
2042  0202 2004          	jra	L5601
2043  0204               L3601:
2044                     ; 587         TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC1P);
2046  0204 72135327      	bres	21287,#1
2047  0208               L5601:
2048                     ; 589 }
2051  0208 81            	ret
2087                     ; 600 void TIM3_OC2PolarityConfig(TIM3_OCPolarity_TypeDef TIM3_OCPolarity)
2087                     ; 601 {
2088                     	switch	.text
2089  0209               _TIM3_OC2PolarityConfig:
2093                     ; 603     assert_param(IS_TIM3_OC_POLARITY_OK(TIM3_OCPolarity));
2095                     ; 606     if (TIM3_OCPolarity != TIM3_OCPOLARITY_HIGH)
2097  0209 4d            	tnz	a
2098  020a 2706          	jreq	L5011
2099                     ; 608         TIM3->CCER1 |= TIM3_CCER1_CC2P;
2101  020c 721a5327      	bset	21287,#5
2103  0210 2004          	jra	L7011
2104  0212               L5011:
2105                     ; 612         TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC2P);
2107  0212 721b5327      	bres	21287,#5
2108  0216               L7011:
2109                     ; 614 }
2112  0216 81            	ret
2157                     ; 627 void TIM3_CCxCmd(TIM3_Channel_TypeDef TIM3_Channel, FunctionalState NewState)
2157                     ; 628 {
2158                     	switch	.text
2159  0217               _TIM3_CCxCmd:
2161  0217 89            	pushw	x
2162       00000000      OFST:	set	0
2165                     ; 630     assert_param(IS_TIM3_CHANNEL_OK(TIM3_Channel));
2167                     ; 631     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2169                     ; 633     if (TIM3_Channel == TIM3_CHANNEL_1)
2171  0218 9e            	ld	a,xh
2172  0219 4d            	tnz	a
2173  021a 2610          	jrne	L3311
2174                     ; 636         if (NewState != DISABLE)
2176  021c 9f            	ld	a,xl
2177  021d 4d            	tnz	a
2178  021e 2706          	jreq	L5311
2179                     ; 638             TIM3->CCER1 |= TIM3_CCER1_CC1E;
2181  0220 72105327      	bset	21287,#0
2183  0224 2014          	jra	L1411
2184  0226               L5311:
2185                     ; 642             TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC1E);
2187  0226 72115327      	bres	21287,#0
2188  022a 200e          	jra	L1411
2189  022c               L3311:
2190                     ; 649         if (NewState != DISABLE)
2192  022c 0d02          	tnz	(OFST+2,sp)
2193  022e 2706          	jreq	L3411
2194                     ; 651             TIM3->CCER1 |= TIM3_CCER1_CC2E;
2196  0230 72185327      	bset	21287,#4
2198  0234 2004          	jra	L1411
2199  0236               L3411:
2200                     ; 655             TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC2E);
2202  0236 72195327      	bres	21287,#4
2203  023a               L1411:
2204                     ; 659 }
2207  023a 85            	popw	x
2208  023b 81            	ret
2253                     ; 680 void TIM3_SelectOCxM(TIM3_Channel_TypeDef TIM3_Channel, TIM3_OCMode_TypeDef TIM3_OCMode)
2253                     ; 681 {
2254                     	switch	.text
2255  023c               _TIM3_SelectOCxM:
2257  023c 89            	pushw	x
2258       00000000      OFST:	set	0
2261                     ; 683     assert_param(IS_TIM3_CHANNEL_OK(TIM3_Channel));
2263                     ; 684     assert_param(IS_TIM3_OCM_OK(TIM3_OCMode));
2265                     ; 686     if (TIM3_Channel == TIM3_CHANNEL_1)
2267  023d 9e            	ld	a,xh
2268  023e 4d            	tnz	a
2269  023f 2610          	jrne	L1711
2270                     ; 689         TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC1E);
2272  0241 72115327      	bres	21287,#0
2273                     ; 692         TIM3->CCMR1 = (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~TIM3_CCMR_OCM)) | (uint8_t)TIM3_OCMode);
...
2281  0251               L1711:
2282                     ; 697         TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC2E);
2284  0251 72195327      	bres	21287,#4
2285                     ; 700         TIM3->CCMR2 = (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~TIM3_CCMR_OCM)) | (uint8_t)TIM3_OCMode);
...
2295  025f 85            	popw	x
2296  0260 81            	ret
2330                     ; 711 void TIM3_SetCounter(uint16_t Counter)
2330                     ; 712 {
2331                     	switch	.text
2332  0261               _TIM3_SetCounter:
2336                     ; 714     TIM3->CNTRH = (uint8_t)(Counter >> 8);
2338  0261 9e            	ld	a,xh
2339  0262 c75328        	ld	21288,a
2340                     ; 715     TIM3->CNTRL = (uint8_t)(Counter);
2342  0265 9f            	ld	a,xl
2343  0266 c75329        	ld	21289,a
2344                     ; 717 }
2347  0269 81            	ret
2381                     ; 726 void TIM3_SetAutoreload(uint16_t Autoreload)
2381                     ; 727 {
2382                     	switch	.text
2383  026a               _TIM3_SetAutoreload:
2387                     ; 729     TIM3->ARRH = (uint8_t)(Autoreload >> 8);
2389  026a 9e            	ld	a,xh
2390  026b c7532b        	ld	21291,a
2391                     ; 730     TIM3->ARRL = (uint8_t)(Autoreload);
2393  026e 9f            	ld	a,xl
2394  026f c7532c        	ld	21292,a
2395                     ; 731 }
2398  0272 81            	ret
2432                     ; 740 void TIM3_SetCompare1(uint16_t Compare1)
2432                     ; 741 {
2433                     	switch	.text
2434  0273               _TIM3_SetCompare1:
2438                     ; 743     TIM3->CCR1H = (uint8_t)(Compare1 >> 8);
2440  0273 9e            	ld	a,xh
2441  0274 c7532d        	ld	21293,a
2442                     ; 744     TIM3->CCR1L = (uint8_t)(Compare1);
2444  0277 9f            	ld	a,xl
2445  0278 c7532e        	ld	21294,a
2446                     ; 745 }
2449  027b 81            	ret
2483                     ; 754 void TIM3_SetCompare2(uint16_t Compare2)
2483                     ; 755 {
2484                     	switch	.text
2485  027c               _TIM3_SetCompare2:
2489                     ; 757     TIM3->CCR2H = (uint8_t)(Compare2 >> 8);
2491  027c 9e            	ld	a,xh
2492  027d c7532f        	ld	21295,a
2493                     ; 758     TIM3->CCR2L = (uint8_t)(Compare2);
2495  0280 9f            	ld	a,xl
2496  0281 c75330        	ld	21296,a
2497                     ; 759 }
2500  0284 81            	ret
2536                     ; 772 void TIM3_SetIC1Prescaler(TIM3_ICPSC_TypeDef TIM3_IC1Prescaler)
2536                     ; 773 {
2537                     	switch	.text
2538  0285               _TIM3_SetIC1Prescaler:
2540  0285 88            	push	a
2541       00000000      OFST:	set	0
2544                     ; 775     assert_param(IS_TIM3_IC_PRESCALER_OK(TIM3_IC1Prescaler));
2546                     ; 778     TIM3->CCMR1 = (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~TIM3_CCMR_ICxPSC)) | (uint8_t)TIM3_IC1Prescaler);
...
2555  0290 84            	pop	a
2556  0291 81            	ret
2592                     ; 791 void TIM3_SetIC2Prescaler(TIM3_ICPSC_TypeDef TIM3_IC2Prescaler)
2592                     ; 792 {
2593                     	switch	.text
2594  0292               _TIM3_SetIC2Prescaler:
2596  0292 88            	push	a
2597       00000000      OFST:	set	0
2600                     ; 794     assert_param(IS_TIM3_IC_PRESCALER_OK(TIM3_IC2Prescaler));
2602                     ; 797     TIM3->CCMR2 = (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~TIM3_CCMR_ICxPSC)) | (uint8_t)TIM3_IC2Prescaler);
...
2812                     ; 836     return (uint16_t)tmpccr2;
2814  02e6 1e03          	ldw	x,(OFST-1,sp)
2817  02e8 5b04          	addw	sp,#4
2818  02ea 81            	ret
2852                     ; 844 uint16_t TIM3_GetCounter(void)
2852                     ; 845 {
2853                     	switch	.text
2854  02eb               _TIM3_GetCounter:
2856  02eb 89            	pushw	x
2857       00000002      OFST:	set	2
2860                     ; 846    uint16_t tmpcntr = 0;
2862                     ; 848    tmpcntr = ((uint16_t)TIM3->CNTRH << 8);
...
2871                     ; 850     return (uint16_t)( tmpcntr| (uint16_t)(TIM3->CNTRL));
...
2884  0303 81            	ret
2908                     ; 859 TIM3_Prescaler_TypeDef TIM3_GetPrescaler(void)
2908                     ; 860 {
2909                     	switch	.text
2910  0304               _TIM3_GetPrescaler:
2914                     ; 862     return (TIM3_Prescaler_TypeDef)(TIM3->PSCR);
2916  0304 c6532a        	ld	a,21290
2919  0307 81            	ret
3044                     ; 877 FlagStatus TIM3_GetFlagStatus(TIM3_FLAG_TypeDef TIM3_FLAG)
3044                     ; 878 {
3045                     	switch	.text
...
3053                     ; 879    FlagStatus bitstatus = RESET;
3055                     ; 880    uint8_t tim3_flag_l = 0, tim3_flag_h = 0;
3059                     ; 883     assert_param(IS_TIM3_GET_FLAG_OK(TIM3_FLAG));
3061                     ; 885     tim3_flag_l = (uint8_t)(TIM3->SR1 & (uint8_t)TIM3_FLAG);
3063  030a 9f            	ld	a,xl
3064  030b c45322        	and	a,21282
3065  030e 6b01          	ld	(OFST-1,sp),a
3067                     ; 886     tim3_flag_h = (uint8_t)((uint16_t)TIM3_FLAG >> 8);
3069  0310 7b03          	ld	a,(OFST+1,sp)
3070  0312 6b02          	ld	(OFST+0,sp),a
3072                     ; 888     if (((tim3_flag_l) | (uint8_t)(TIM3->SR2 & tim3_flag_h)) != (uint8_t)RESET )
3074  0314 c65323        	ld	a,21283
3075  0317 1402          	and	a,(OFST+0,sp)
3076  0319 1a01          	or	a,(OFST-1,sp)
3077  031b 2706          	jreq	L3051
3078                     ; 890         bitstatus = SET;
3080  031d a601          	ld	a,#1
3081  031f 6b02          	ld	(OFST+0,sp),a
3084  0321 2002          	jra	L5051
3085  0323               L3051:
3086                     ; 894         bitstatus = RESET;
3088  0323 0f02          	clr	(OFST+0,sp)
3090  0325               L5051:
3091                     ; 896     return (FlagStatus)bitstatus;
3093  0325 7b02          	ld	a,(OFST+0,sp)
3096  0327 5b04          	addw	sp,#4
3097  0329 81            	ret
3132                     ; 911 void TIM3_ClearFlag(TIM3_FLAG_TypeDef TIM3_FLAG)
3132                     ; 912 {
3133                     	switch	.text
3134  032a               _TIM3_ClearFlag:
3136  032a 89            	pushw	x
3137       00000000      OFST:	set	0
3140                     ; 914     assert_param(IS_TIM3_CLEAR_FLAG_OK(TIM3_FLAG));
3142                     ; 917     TIM3->SR1 = (uint8_t)(~((uint8_t)(TIM3_FLAG)));
3144  032b 9f            	ld	a,xl
3145  032c 43            	cpl	a
3146  032d c75322        	ld	21282,a
3147                     ; 918     TIM3->SR2 = (uint8_t)(~((uint8_t)((uint16_t)TIM3_FLAG >> 8)));
...
3155  0336 85            	popw	x
3156  0337 81            	ret
3220                     ; 932 ITStatus TIM3_GetITStatus(TIM3_IT_TypeDef TIM3_IT)
3220                     ; 933 {
3221                     	switch	.text
...
3229                     ; 934     ITStatus bitstatus = RESET;
3231                     ; 935     uint8_t TIM3_itStatus = 0, TIM3_itEnable = 0;
3235                     ; 938     assert_param(IS_TIM3_GET_IT_OK(TIM3_IT));
3237                     ; 940     TIM3_itStatus = (uint8_t)(TIM3->SR1 & TIM3_IT);
3239  033a c45322        	and	a,21282
3240  033d 6b01          	ld	(OFST-1,sp),a
3242                     ; 942     TIM3_itEnable = (uint8_t)(TIM3->IER & TIM3_IT);
3244  033f c65321        	ld	a,21281
3245  0342 1403          	and	a,(OFST+1,sp)
3246  0344 6b02          	ld	(OFST+0,sp),a
3248                     ; 944     if ((TIM3_itStatus != (uint8_t)RESET ) && (TIM3_itEnable != (uint8_t)RESET ))
3250  0346 0d01          	tnz	(OFST-1,sp)
3251  0348 270a          	jreq	L7551
3253  034a 0d02          	tnz	(OFST+0,sp)
3254  034c 2706          	jreq	L7551
3255                     ; 946         bitstatus = SET;
3257  034e a601          	ld	a,#1
3258  0350 6b02          	ld	(OFST+0,sp),a
3261  0352 2002          	jra	L1651
3262  0354               L7551:
3263                     ; 950         bitstatus = RESET;
3265  0354 0f02          	clr	(OFST+0,sp)
3267  0356               L1651:
3268                     ; 952     return (ITStatus)(bitstatus);
3270  0356 7b02          	ld	a,(OFST+0,sp)
3273  0358 5b03          	addw	sp,#3
3274  035a 81            	ret
3310                     ; 965 void TIM3_ClearITPendingBit(TIM3_IT_TypeDef TIM3_IT)
3310                     ; 966 {
3311                     	switch	.text
3312  035b               _TIM3_ClearITPendingBit:
3316                     ; 968     assert_param(IS_TIM3_IT_OK(TIM3_IT));
3318                     ; 971     TIM3->SR1 = (uint8_t)(~TIM3_IT);
3320  035b 43            	cpl	a
3321  035c c75322        	ld	21282,a
3322                     ; 972 }
3325  035f 81            	ret
3377                     ; 991 static void TI1_Config(uint8_t TIM3_ICPolarity,
3377                     ; 992                        uint8_t TIM3_ICSelection,
3377                     ; 993                        uint8_t TIM3_ICFilter)
3377                     ; 994 {
3378                     	switch	.text
...
3386                     ; 996     TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC1E);
3388  0362 72115327      	bres	21287,#0
3389                     ; 999     TIM3->CCMR1 = (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~( TIM3_CCMR_CCxS | TIM3_CCMR_ICxF))) | (uint8_t)(( (TIM3_ICSelection)) | ((uint8_t)( TIM3_ICFilter << 4))));
...
3403                     ; 1002     if (TIM3_ICPolarity != TIM3_ICPOLARITY_RISING)
3405  037b 0d02          	tnz	(OFST+1,sp)
3406  037d 2706          	jreq	L7261
3407                     ; 1004         TIM3->CCER1 |= TIM3_CCER1_CC1P;
3409  037f 72125327      	bset	21287,#1
3411  0383 2004          	jra	L1361
3412  0385               L7261:
3413                     ; 1008         TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC1P);
3415  0385 72135327      	bres	21287,#1
3416  0389               L1361:
3417                     ; 1011     TIM3->CCER1 |= TIM3_CCER1_CC1E;
3419  0389 72105327      	bset	21287,#0
3420                     ; 1012 }
3423  038d 5b03          	addw	sp,#3
3424  038f 81            	ret
3476                     ; 1031 static void TI2_Config(uint8_t TIM3_ICPolarity,
3476                     ; 1032                        uint8_t TIM3_ICSelection,
3476                     ; 1033                        uint8_t TIM3_ICFilter)
3476                     ; 1034 {
3477                     	switch	.text
...
3485                     ; 1036     TIM3->CCER1 &=  (uint8_t)(~TIM3_CCER1_CC2E);
3487  0392 72195327      	bres	21287,#4
3488                     ; 1039     TIM3->CCMR2 = (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~( TIM3_CCMR_CCxS |
3488                     ; 1040                   TIM3_CCMR_ICxF    ))) | (uint8_t)(( (TIM3_ICSelection)) | 
3488                     ; 1041                   ((uint8_t)( TIM3_ICFilter << 4))));
...
3502                     ; 1044     if (TIM3_ICPolarity != TIM3_ICPOLARITY_RISING)
3504  03ab 0d02          	tnz	(OFST+1,sp)
3505  03ad 2706          	jreq	L1661
3506                     ; 1046         TIM3->CCER1 |= TIM3_CCER1_CC2P;
3508  03af 721a5327      	bset	21287,#5
3510  03b3 2004          	jra	L3661
3511  03b5               L1661:
3512                     ; 1050         TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC2P);
3514  03b5 721b5327      	bres	21287,#5
3515  03b9               L3661:
3516                     ; 1054     TIM3->CCER1 |= TIM3_CCER1_CC2E;
