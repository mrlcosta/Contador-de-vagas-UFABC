...
extern uint16_t	contador_debounce_sensor_saida;
extern uint16_t	contador_debounce_sensor_entrada;
extern uint16_t	contador_debounce_bt_confirma;
...
{		
	...
	contador_debounce_sensor_saida++;
	contador_debounce_sensor_entrada++;
	contador_buzzer++;
